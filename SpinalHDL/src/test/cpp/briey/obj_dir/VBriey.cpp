...
VL_INLINE_OPT void VBriey::_sequent__TOP__1(VBriey__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBriey::_sequent__TOP__1\n"); );
    VBriey* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
VL_INLINE_OPT void VBriey::_sequent__TOP__2(VBriey__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBriey::_sequent__TOP__2\n"); );
    VBriey* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->io_jtag_tdo = vlSymsp->TOP__Briey.__PVT__jtagBridge_1___DOT__jtag_tap_tdoUnbufferd_regNext;
}

VL_INLINE_OPT void VBriey::_sequent__TOP__3(VBriey__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBriey::_sequent__TOP__3\n"); );
    VBriey* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
void VBriey::_settle__TOP__4(VBriey__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBriey::_settle__TOP__4\n"); );
    VBriey* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->io_vga_colorEn = vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__vga__DOT__videoOn;
    vlTOPp->io_vga_hSync = vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__vga__DOT__hSyncDelay;
...
void VBriey::_eval(VBriey__Syms* __restrict vlSymsp) {
	...
	vlSymsp->TOP__Briey._sequent__TOP__Briey__2(vlSymsp);
	vlTOPp->__Vm_traceActivity = (2U | vlTOPp->__Vm_traceActivity);
	vlSymsp->TOP__Briey__axi_core_cpu._sequent__TOP__Briey__axi_core_cpu__2(vlSymsp);
	vlTOPp->_sequent__TOP__1(vlSymsp);
	vlSymsp->TOP__Briey._sequent__TOP__Briey__3(vlSymsp);
    }
    ...
    if ((((IData)(vlTOPp->__VinpClk__TOP__Briey____PVT__resetCtrl_axiReset) 
	  & (~ (IData)(vlTOPp->__Vclklast__TOP____VinpClk__TOP__Briey____PVT__resetCtrl_axiReset))) 
	 | ((IData)(vlTOPp->io_axiClk) & (~ (IData)(vlTOPp->__Vclklast__TOP__io_axiClk))))) {
	vlSymsp->TOP__Briey._sequent__TOP__Briey__14(vlSymsp);
...
void VBriey::_eval_settle(VBriey__Syms* __restrict vlSymsp) {
    ...
    VBriey* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlSymsp->TOP__Briey._settle__TOP__Briey__9(vlSymsp);
    vlTOPp->__Vm_traceActivity = (1U | vlTOPp->__Vm_traceActivity);
    vlTOPp->_settle__TOP__4(vlSymsp);
    vlSymsp->TOP__Briey__axi_core_cpu._settle__TOP__Briey__axi_core_cpu__6(vlSymsp);
    vlSymsp->TOP__Briey._settle__TOP__Briey__10(vlSymsp);
}
...
VL_INLINE_OPT QData VBriey::_change_request(VBriey__Syms* __restrict vlSymsp) {
    ...
    VL_DEBUG_IF( if(__req && ((vlSymsp->TOP__Briey.__PVT__resetCtrl_systemReset ^ vlTOPp->__Vchglast__TOP__Briey__resetCtrl_systemReset))) VL_DBG_MSGF("        CHANGE: ../../../../Briey.v:20097: resetCtrl_systemReset\n"); );
    VL_DEBUG_IF( if(__req && ((vlSymsp->TOP__Briey.__PVT__resetCtrl_axiReset ^ vlTOPp->__Vchglast__TOP__Briey__resetCtrl_axiReset))) VL_DBG_MSGF("        CHANGE: ../../../../Briey.v:20098: resetCtrl_axiReset\n"); );
    // Final
...
void VBriey::_ctor_var_reset() {
    ...
    io_vga_rgb_0 = VL_RAND_RESET_I(1);
    io_vga_rgb_1 = VL_RAND_RESET_I(1);
    io_vga_rgb_2 = VL_RAND_RESET_I(1);
