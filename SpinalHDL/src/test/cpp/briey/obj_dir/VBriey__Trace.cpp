...
void VBriey::traceChgThis__4(VBriey__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->chgBus(c+10,(vlSymsp->TOP__Briey.__PVT__axi_ram__DOT__unburstify_buffer_result),12);
	...
	vcdp->chgArray(c+35,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_SRC1_CTRL_string),96);
	vcdp->chgArray(c+38,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_SHIFT_CTRL_string),72);
	vcdp->chgArray(c+41,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__execute_to_memory_SHIFT_CTRL_string),72);
    }
}
...
void VBriey::traceChgThis__7(VBriey__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBus(c+69,(((2U == (IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_ALU_CTRL))
	...
	vcdp->chgBit(c+70,((((IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_PREDICTION_HAD_BRANCHED2) 
	...
	vcdp->chgBus(c+72,((IData)((VL_ULL(0x1ffffffff) 
...
void VBriey::traceChgThis__9(VBriey__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBus(c+77,((0xfffU & ((IData)(vlSymsp->TOP__Briey.__PVT__axi_ram_io_axi_arbiter__DOT__cmdArbiter__DOT__maskRouted_0)
...
void VBriey::traceChgThis__14(VBriey__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->chgBus(c+126,(vlSymsp->TOP__Briey.__PVT__axi_ram__DOT__arw_payload_fragment_addr),12);
	...
	vcdp->chgBus(c+183,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__bresCircle_io_address_0),10);
	vcdp->chgBus(c+184,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__bresCircle_io_address_1),9);
	...
	vcdp->chgBus(c+190,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__bresLine__DOT__e2),20);
...
void VBriey::traceChgThis__18(VBriey__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->chgBus(c+363,(((0xffffU & vlSymsp->TOP__Briey__axi_core_cpu.__PVT___zz_151_) 
			     * (0xffffU & vlSymsp->TOP__Briey__axi_core_cpu.__PVT___zz_156_))),32);
	vcdp->chgBus(c+364,((3U & vlSymsp->TOP__Briey__axi_core_cpu.__PVT__execute_SrcPlugin_addSub)),2);
	vcdp->chgQuad(c+365,((VL_ULL(0x3ffffffff) & 
	...
	vcdp->chgQuad(c+367,((VL_ULL(0x3ffffffff) & 
			      VL_MULS_QQQ(34,34,34, 
					  (VL_ULL(0x3ffffffff) 
					   & VL_EXTENDS_QI(34,17, 
							   (0xffffU 
					  ...
					  (VL_ULL(0x3ffffffff) 
					   & VL_EXTENDS_QI(34,17, vlSymsp->TOP__Briey__axi_core_cpu.__PVT__execute_MulPlugin_bHigh))))),34);
	vcdp->chgQuad(c+369,((VL_ULL(0x3ffffffff) & 
			      VL_MULS_QQQ(34,34,34, 
					  (VL_ULL(0x3ffffffff) 
					   & VL_EXTENDS_QI(34,17, vlSymsp->TOP__Briey__axi_core_cpu.__PVT__execute_MulPlugin_aHigh)), 
					  (VL_ULL(0x3ffffffff) 
...
void VBriey::traceChgThis__22(VBriey__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->chgBus(c+545,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT___zz_5_),20);
	vcdp->chgBus(c+546,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT___zz_6_),11);
	vcdp->chgBus(c+547,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT___zz_7_),10);
	vcdp->chgBus(c+548,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT___zz_8_),11);
	vcdp->chgBus(c+549,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT___zz_9_),10);
	...
	vcdp->chgBus(c+557,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT___zz_11_),11);
	vcdp->chgBus(c+558,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT___zz_12_),10);
	vcdp->chgBus(c+559,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT___zz_13_),11);
	...
	vcdp->chgBus(c+568,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT___zz_15_),10);
	vcdp->chgBus(c+569,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT___zz_16_),9);
	vcdp->chgBus(c+570,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT___zz_17_),10);
	vcdp->chgBus(c+571,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT___zz_18_),9);
	...
	vcdp->chgBit(c+595,((((IData)(vlSymsp->TOP__Briey.__PVT__axi_gpu_io_axiram_ar_halfPipe_regs_valid) 
			      & (~ (IData)(vlSymsp->TOP__Briey.__PVT__axi_gpu_io_axiram_decoder__DOT__decodedCmdSels))) 
			     & (IData)(vlSymsp->TOP__Briey.__PVT__axi_gpu_io_axiram_decoder__DOT__allowCmd))));
	vcdp->chgBus(c+596,((0xfffU & vlSymsp->TOP__Briey.__PVT__axi_core_cpu_dBus_cmd_m2sPipe_m2sPipe_s2mPipe_payload_address)),12);
	...
	vcdp->chgBit(c+635,((1U & (vlSymsp->TOP__Briey__axi_core_cpu.__PVT___zz_137_ 
				   >> 0x1bU))));
	vcdp->chgBit(c+636,((1U & (vlSymsp->TOP__Briey__axi_core_cpu.__PVT___zz_137_ 
				   >> 3U))));
	vcdp->chgBit(c+637,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_decodePrediction_cmd_hadBranch));
	vcdp->chgBit(c+638,((1U & (vlSymsp->TOP__Briey__axi_core_cpu.__PVT___zz_137_ 
				   >> 0xbU))));
	vcdp->chgBit(c+639,((1U & (~ (((1U == (3U & 
	...
	vcdp->chgBit(c+640,((1U & (vlSymsp->TOP__Briey__axi_core_cpu.__PVT___zz_137_ 
				   >> 0x14U))));
	vcdp->chgBit(c+641,((0x20U != (0x7fU & (vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_INSTRUCTION 
						>> 7U)))));
	...
	vcdp->chgBit(c+645,((1U & ((vlSymsp->TOP__Briey__axi_core_cpu.__PVT___zz_137_ 
				    >> 0xaU) & (~ (vlSymsp->TOP__Briey__axi_core_cpu.__PVT___zz_137_ 
						   >> 0x19U))))));
	vcdp->chgBus(c+646,((3U & (vlSymsp->TOP__Briey__axi_core_cpu.__PVT___zz_137_ 
				   >> 0x1dU))),2);
	...
	vcdp->chgBus(c+650,((3U & (vlSymsp->TOP__Briey__axi_core_cpu.__PVT___zz_137_ 
				   >> 8U))),2);
	vcdp->chgBus(c+651,((3U & vlSymsp->TOP__Briey__axi_core_cpu.__PVT___zz_137_)),2);
	...
	vcdp->chgBus(c+700,(((0x80000U & vlSymsp->TOP__Briey__axi_core_cpu.__PVT___zz_137_)
			      ? ((0x80000U & vlSymsp->TOP__Briey__axi_core_cpu.__PVT___zz_137_)
				  ? 0x58524554U : 0x3f3f3f3fU)
			      : 0x4e4f4e45U)),32);
	vcdp->chgArray(c+701,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_SHIFT_CTRL_string),72);
	vcdp->chgQuad(c+704,(((0U == (3U & (vlSymsp->TOP__Briey__axi_core_cpu.__PVT___zz_137_ 
					    >> 0x11U)))
	...
	vcdp->chgBus(c+706,(((0x40U & vlSymsp->TOP__Briey__axi_core_cpu.__PVT___zz_137_)
	...
	vcdp->chgArray(c+709,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_SRC1_CTRL_string),96);
	vcdp->chgBus(c+712,(((0x1000000U & vlSymsp->TOP__Briey__axi_core_cpu.__PVT___zz_137_)
...
void VBriey::traceChgThis__31(VBriey__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->chgBus(c+831,(vlSymsp->TOP__Briey.__PVT__axi_ram_io_axi_arbiter_io_output_arw_halfPipe_regs_payload_addr),12);
	...
	vcdp->chgBus(c+856,(vlSymsp->TOP__Briey.__PVT__axi_ram__DOT__unburstify_buffer_transaction_addr),12);
	...
	vcdp->chgBus(c+862,((((2U == (3U & (IData)(vlSymsp->TOP__Briey.__PVT__axi_ram__DOT__unburstify_buffer_transaction_size))) 
			      << 2U) | (((1U == (3U 
	...
	vcdp->chgBus(c+863,((((1U < (3U & (IData)(vlSymsp->TOP__Briey.__PVT__axi_ram__DOT__unburstify_buffer_transaction_size))) 
			      << 1U) | (0U < (3U & (IData)(vlSymsp->TOP__Briey.__PVT__axi_ram__DOT__unburstify_buffer_transaction_size))))),12);
	vcdp->chgBus(c+864,(vlSymsp->TOP__Briey.__PVT__axi_ram__DOT___zz_8_),12);
	vcdp->chgBus(c+865,(vlSymsp->TOP__Briey.__PVT__axi_ram__DOT___zz_10_),3);
	vcdp->chgBus(c+866,(vlSymsp->TOP__Briey.__PVT__axi_ram__DOT___zz_11_),2);
	vcdp->chgBit(c+867,(vlSymsp->TOP__Briey.__PVT__axi_ram__DOT___zz_12_));
	vcdp->chgBus(c+868,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl_io_bus_rsp_payload_data_regNextWhen),16);
	vcdp->chgBus(c+869,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__unburstify_buffer_len),8);
	vcdp->chgBus(c+870,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__unburstify_buffer_transaction_addr),26);
	vcdp->chgBus(c+871,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__unburstify_buffer_transaction_id),4);
	vcdp->chgBus(c+872,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__unburstify_buffer_transaction_size),3);
	vcdp->chgBus(c+873,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__unburstify_buffer_transaction_burst),2);
	vcdp->chgBit(c+874,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__unburstify_buffer_transaction_write));
	vcdp->chgBus(c+875,((3U & (IData)(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__unburstify_buffer_transaction_size))),2);
	vcdp->chgBus(c+876,((0x3fffU & (vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__unburstify_buffer_transaction_addr 
					>> 0xcU))),14);
	vcdp->chgBus(c+877,((((2U == (3U & (IData)(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__unburstify_buffer_transaction_size))) 
			      << 2U) | (((1U == (3U 
	...
	vcdp->chgBus(c+878,((((1U < (3U & (IData)(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__unburstify_buffer_transaction_size))) 
			      << 1U) | (0U < (3U & (IData)(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__unburstify_buffer_transaction_size))))),12);
	vcdp->chgBus(c+879,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__frontend_banks_0_row),13);
	vcdp->chgBus(c+880,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__frontend_banks_1_row),13);
	vcdp->chgBus(c+881,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__frontend_banks_2_row),13);
	vcdp->chgBus(c+882,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__frontend_banks_3_row),13);
	vcdp->chgBus(c+883,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT___zz_12_),13);
	vcdp->chgBus(c+884,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT___zz_13_),16);
	vcdp->chgBus(c+885,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT___zz_14_),2);
	vcdp->chgBus(c+886,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT___zz_15_),4);
	vcdp->chgBit(c+887,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT___zz_16_));
	vcdp->chgBus(c+888,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__chip_sdram_DQ_read),16);
	vcdp->chgBus(c+889,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__chip_cmd_payload_context_delay_1_id),4);
	vcdp->chgBit(c+890,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__chip_cmd_payload_context_delay_1_last));
	vcdp->chgBus(c+891,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__chip_cmd_payload_context_delay_2_id),4);
	vcdp->chgBit(c+892,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__chip_cmd_payload_context_delay_2_last));
	vcdp->chgBus(c+893,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__chip_cmd_payload_context_delay_3_id),4);
	vcdp->chgBit(c+894,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__chip_cmd_payload_context_delay_3_last));
	vcdp->chgBus(c+895,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__chip_cmd_payload_context_delay_4_id),4);
	vcdp->chgBit(c+896,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__chip_cmd_payload_context_delay_4_last));
	vcdp->chgBus(c+897,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__chip_contextDelayed_id),4);
	vcdp->chgBit(c+898,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__chip_contextDelayed_last));
	vcdp->chgBus(c+899,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__chip_backupIn_fifo__DOT__ram[0]),21);
	vcdp->chgBus(c+900,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__chip_backupIn_fifo__DOT__ram[1]),21);
	vcdp->chgBit(c+901,(vlSymsp->TOP__Briey.__PVT__axi_apbBridge__DOT__write));
	vcdp->chgBus(c+902,(vlSymsp->TOP__Briey.__PVT__axi_gpioACtrl__DOT__bufferCC_8___DOT__buffers_0),32);
	vcdp->chgBus(c+903,(vlSymsp->TOP__Briey.__PVT__axi_gpioBCtrl__DOT__bufferCC_8___DOT__buffers_0),32);
	vcdp->chgBit(c+904,(vlSymsp->TOP__Briey.__PVT__axi_timerCtrl__DOT__bufferCC_8___DOT__buffers_1_clear));
	vcdp->chgBit(c+905,(vlSymsp->TOP__Briey.__PVT__axi_timerCtrl__DOT__bufferCC_8___DOT__buffers_1_tick));
	vcdp->chgBus(c+906,(vlSymsp->TOP__Briey.__PVT__axi_timerCtrl__DOT__timerA__DOT__counter),32);
	vcdp->chgBus(c+907,(vlSymsp->TOP__Briey.__PVT__axi_timerCtrl__DOT__timerB__DOT__counter),16);
	vcdp->chgBus(c+908,(vlSymsp->TOP__Briey.__PVT__axi_timerCtrl__DOT__timerC__DOT__counter),16);
	vcdp->chgBus(c+909,(vlSymsp->TOP__Briey.__PVT__axi_timerCtrl__DOT__timerD__DOT__counter),16);
	vcdp->chgBus(c+910,(vlSymsp->TOP__Briey.__PVT__axi_timerCtrl__DOT__timerA_io_limit_driver),32);
	vcdp->chgBus(c+911,(vlSymsp->TOP__Briey.__PVT__axi_timerCtrl__DOT__timerB_io_limit_driver),16);
	vcdp->chgBus(c+912,(vlSymsp->TOP__Briey.__PVT__axi_timerCtrl__DOT__timerC_io_limit_driver),16);
	vcdp->chgBus(c+913,(vlSymsp->TOP__Briey.__PVT__axi_timerCtrl__DOT__timerD_io_limit_driver),16);
	vcdp->chgBit(c+914,(vlSymsp->TOP__Briey.__PVT__axi_timerCtrl__DOT__bufferCC_8___DOT__buffers_0_clear));
	vcdp->chgBit(c+915,(vlSymsp->TOP__Briey.__PVT__axi_timerCtrl__DOT__bufferCC_8___DOT__buffers_0_tick));
	vcdp->chgBus(c+916,(vlSymsp->TOP__Briey.__PVT__axi_timerCtrl__DOT___zz_1_),16);
	vcdp->chgBus(c+917,(vlSymsp->TOP__Briey.__PVT__axi_timerCtrl__DOT__prescaler_1___DOT__counter),16);
	vcdp->chgBus(c+918,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___DOT__rx__DOT__stateMachine_shifter),8);
	vcdp->chgBus(c+919,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__bridge_write_streamUnbuffered_queueWithOccupancy__DOT___zz_3_),8);
	vcdp->chgBus(c+920,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___05Fio_read_queueWithOccupancy__DOT___zz_3_),8);
	vcdp->chgBus(c+921,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__bridge_uartConfigReg_frame_dataLength),3);
	vcdp->chgBit(c+922,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___DOT__tx__DOT__stateMachine_parity));
	vcdp->chgBus(c+923,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___DOT__rx__DOT__bitTimer_counter),3);
	vcdp->chgBus(c+924,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__bridge_write_streamUnbuffered_queueWithOccupancy__DOT__logic_ram[0]),8);
	vcdp->chgBus(c+925,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__bridge_write_streamUnbuffered_queueWithOccupancy__DOT__logic_ram[1]),8);
	vcdp->chgBus(c+926,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__bridge_write_streamUnbuffered_queueWithOccupancy__DOT__logic_ram[2]),8);
	vcdp->chgBus(c+927,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__bridge_write_streamUnbuffered_queueWithOccupancy__DOT__logic_ram[3]),8);
	vcdp->chgBus(c+928,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__bridge_write_streamUnbuffered_queueWithOccupancy__DOT__logic_ram[4]),8);
	vcdp->chgBus(c+929,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__bridge_write_streamUnbuffered_queueWithOccupancy__DOT__logic_ram[5]),8);
	vcdp->chgBus(c+930,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__bridge_write_streamUnbuffered_queueWithOccupancy__DOT__logic_ram[6]),8);
	vcdp->chgBus(c+931,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__bridge_write_streamUnbuffered_queueWithOccupancy__DOT__logic_ram[7]),8);
	vcdp->chgBus(c+932,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__bridge_write_streamUnbuffered_queueWithOccupancy__DOT__logic_ram[8]),8);
	vcdp->chgBus(c+933,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__bridge_write_streamUnbuffered_queueWithOccupancy__DOT__logic_ram[9]),8);
	vcdp->chgBus(c+934,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__bridge_write_streamUnbuffered_queueWithOccupancy__DOT__logic_ram[10]),8);
	vcdp->chgBus(c+935,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__bridge_write_streamUnbuffered_queueWithOccupancy__DOT__logic_ram[11]),8);
	vcdp->chgBus(c+936,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__bridge_write_streamUnbuffered_queueWithOccupancy__DOT__logic_ram[12]),8);
	vcdp->chgBus(c+937,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__bridge_write_streamUnbuffered_queueWithOccupancy__DOT__logic_ram[13]),8);
	vcdp->chgBus(c+938,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__bridge_write_streamUnbuffered_queueWithOccupancy__DOT__logic_ram[14]),8);
	vcdp->chgBus(c+939,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__bridge_write_streamUnbuffered_queueWithOccupancy__DOT__logic_ram[15]),8);
	vcdp->chgBus(c+940,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___05Fio_read_queueWithOccupancy__DOT__logic_ram[0]),8);
	vcdp->chgBus(c+941,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___05Fio_read_queueWithOccupancy__DOT__logic_ram[1]),8);
	vcdp->chgBus(c+942,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___05Fio_read_queueWithOccupancy__DOT__logic_ram[2]),8);
	vcdp->chgBus(c+943,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___05Fio_read_queueWithOccupancy__DOT__logic_ram[3]),8);
	vcdp->chgBus(c+944,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___05Fio_read_queueWithOccupancy__DOT__logic_ram[4]),8);
	vcdp->chgBus(c+945,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___05Fio_read_queueWithOccupancy__DOT__logic_ram[5]),8);
	vcdp->chgBus(c+946,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___05Fio_read_queueWithOccupancy__DOT__logic_ram[6]),8);
	vcdp->chgBus(c+947,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___05Fio_read_queueWithOccupancy__DOT__logic_ram[7]),8);
	vcdp->chgBus(c+948,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___05Fio_read_queueWithOccupancy__DOT__logic_ram[8]),8);
	vcdp->chgBus(c+949,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___05Fio_read_queueWithOccupancy__DOT__logic_ram[9]),8);
	vcdp->chgBus(c+950,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___05Fio_read_queueWithOccupancy__DOT__logic_ram[10]),8);
	vcdp->chgBus(c+951,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___05Fio_read_queueWithOccupancy__DOT__logic_ram[11]),8);
	vcdp->chgBus(c+952,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___05Fio_read_queueWithOccupancy__DOT__logic_ram[12]),8);
	vcdp->chgBus(c+953,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___05Fio_read_queueWithOccupancy__DOT__logic_ram[13]),8);
	vcdp->chgBus(c+954,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___05Fio_read_queueWithOccupancy__DOT__logic_ram[14]),8);
	vcdp->chgBus(c+955,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___05Fio_read_queueWithOccupancy__DOT__logic_ram[15]),8);
	vcdp->chgBit(c+956,((1U & (IData)(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__vga__DOT__buffer_2___DOT___zz_4_))));
	...
	vcdp->chgBit(c+958,((1U & ((IData)(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__vga__DOT__buffer_2___DOT___zz_4_) 
				   >> 2U))));
	vcdp->chgBus(c+959,((((IData)(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__fillRect__DOT__counterY) 
			      << 0xaU) | (IData)(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__fillRect__DOT__counterX))),19);
	vcdp->chgBus(c+960,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__storeVals1_0),10);
	vcdp->chgBus(c+961,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__storeVals1_1),9);
	vcdp->chgBus(c+962,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__storeVals2_0),10);
	vcdp->chgBus(c+963,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__storeVals2_1),9);
	vcdp->chgBit(c+964,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__storeColor_0));
	vcdp->chgBit(c+965,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__storeColor_1));
	vcdp->chgBit(c+966,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__storeColor_2));
	vcdp->chgBit(c+967,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__write));
	vcdp->chgBus(c+968,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__mode),3);
	vcdp->chgQuad(c+969,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__alpha),64);
	vcdp->chgBit(c+971,((1U & (IData)(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__vga__DOT__buffer_2___DOT___zz_5_))));
	...
	vcdp->chgBit(c+973,((1U & ((IData)(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__vga__DOT__buffer_2___DOT___zz_5_) 
				   >> 2U))));
	vcdp->chgBus(c+974,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__fillRect__DOT__counterX),10);
	vcdp->chgBus(c+975,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__fillRect__DOT__counterY),9);
	vcdp->chgBus(c+976,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__fillRect__DOT__x1),10);
	vcdp->chgBus(c+977,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__fillRect__DOT__x2),10);
	vcdp->chgBus(c+978,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__fillRect__DOT__y2),9);
	vcdp->chgBit(c+979,(vlSymsp->TOP__Briey.__PVT__bufferCC_10___DOT__buffers_0));
	vcdp->chgBit(c+980,(vlSymsp->TOP__Briey.__PVT__jtagBridge_1___DOT__flowCCByToggle_1___DOT__bufferCC_8___DOT__buffers_1));
	vcdp->chgBit(c+981,(vlSymsp->TOP__Briey.__PVT__jtagBridge_1___DOT__flowCCByToggle_1___DOT__outputArea_hit));
	vcdp->chgBit(c+982,(vlSymsp->TOP__Briey.__PVT__jtagBridge_1___DOT__flowCCByToggle_1___DOT__bufferCC_8___DOT__buffers_0));
	vcdp->chgBus(c+983,(vlSymsp->TOP__Briey.__PVT__systemDebugger_1___DOT__dispatcher_headerShifter),8);
	vcdp->chgBus(c+984,((0xfe0U & vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT__lineLoader_address)),12);
	vcdp->chgBit(c+985,((1U & ((IData)(vlSymsp->TOP__Briey.__PVT__axi_ram__DOT___zz_9_) 
				   >> 3U))));
	vcdp->chgBit(c+986,((1U & (~ ((IData)(vlSymsp->TOP__Briey.__PVT__axi_ram__DOT___zz_9_) 
				      >> 3U)))));
	vcdp->chgBus(c+987,((0x3ffffe0U & vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT__lineLoader_address)),26);
	vcdp->chgBus(c+988,((0x3ffffffU & vlSymsp->TOP__Briey.__PVT__axi_gpu_io_axiram_ar_halfPipe_regs_payload_addr)),26);
	vcdp->chgBus(c+989,(vlSymsp->TOP__Briey.__PVT__apb3Router_1___DOT__selIndex),2);
	vcdp->chgBus(c+990,(((IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_s1_tightlyCoupledHit)
			      ? 0U : vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT___zz_12_)),32);
	vcdp->chgBit(c+991,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT__decodeStage_hit_tags_0_error));
	vcdp->chgBit(c+992,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_s1_tightlyCoupledHit));
	vcdp->chgBit(c+993,((1U & ((~ (IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_s1_tightlyCoupledHit)) 
	...
	vcdp->chgBit(c+994,((1U & (~ ((IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT__decodeStage_hit_tags_0_valid) 
				      & (vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT__decodeStage_hit_tags_0_address 
					 == (0xffffffU 
					     & (vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT__decodeStage_mmuRsp_physicalAddress 
						>> 8U))))))));
	vcdp->chgBus(c+995,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT__decodeStage_mmuRsp_physicalAddress),32);
	vcdp->chgBit(c+996,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__dataCache_1___DOT__stageA_request_wr));
	vcdp->chgBit(c+997,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__dataCache_1___DOT__stageB_request_wr));
	vcdp->chgBus(c+998,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__execute_to_memory_MEMORY_ADDRESS_LOW),2);
	vcdp->chgBit(c+999,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__execute_to_memory_MEMORY_WR));
	vcdp->chgBus(c+1000,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__execute_to_memory_PC),32);
	vcdp->chgBus(c+1001,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__memory_to_writeBack_FORMAL_PC_NEXT),32);
	vcdp->chgBus(c+1002,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__execute_to_memory_FORMAL_PC_NEXT),32);
	vcdp->chgBus(c+1003,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_FORMAL_PC_NEXT),32);
	vcdp->chgBus(c+1004,(((IData)(4U) + vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT__decodeStage_mmuRsp_physicalAddress)),32);
	...
	vcdp->chgQuad(c+1007,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__execute_to_memory_MUL_HH),34);
	vcdp->chgBit(c+1009,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_BYPASSABLE_MEMORY_STAGE));
	vcdp->chgQuad(c+1010,((VL_ULL(0xfffffffffffff) 
			       & (((((QData)((IData)(
						     (0x7ffffU 
						      & VL_NEGATE_I((IData)(
									    (1U 
				  ...
				  + (((QData)((IData)(
				      ...
				      << 0x32U) | (VL_ULL(0x3ffffffffffff) 
						   & (vlSymsp->TOP__Briey__axi_core_cpu.__PVT__execute_to_memory_MUL_HL 
						      << 0x10U)))))),52);
	vcdp->chgBit(c+1012,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_DO_EBREAK));
	vcdp->chgBit(c+1013,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_CSR_READ_OPCODE));
	vcdp->chgBit(c+1014,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_CSR_WRITE_OPCODE));
	vcdp->chgBit(c+1015,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_IS_CSR));
	vcdp->chgBit(c+1016,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__execute_to_memory_ENV_CTRL));
	vcdp->chgBit(c+1017,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_ENV_CTRL));
	vcdp->chgBit(c+1018,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__memory_to_writeBack_ENV_CTRL));
	vcdp->chgBus(c+1019,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__execute_to_memory_BRANCH_CALC),32);
	vcdp->chgBit(c+1020,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__execute_to_memory_BRANCH_DO));
	vcdp->chgBus(c+1021,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_PC),32);
	vcdp->chgBit(c+1022,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_PREDICTION_HAD_BRANCHED2));
	vcdp->chgBus(c+1023,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_BRANCH_CTRL),2);
	vcdp->chgBit(c+1024,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_REGFILE_WRITE_VALID));
	vcdp->chgBit(c+1025,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_BYPASSABLE_EXECUTE_STAGE));
	vcdp->chgBit(c+1026,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__execute_to_memory_REGFILE_WRITE_VALID));
	vcdp->chgBit(c+1027,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__execute_to_memory_BYPASSABLE_MEMORY_STAGE));
	vcdp->chgBit(c+1028,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__memory_to_writeBack_REGFILE_WRITE_VALID));
	vcdp->chgBit(c+1029,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_IS_RS1_SIGNED));
	vcdp->chgBus(c+1030,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_RS1),32);
	vcdp->chgBit(c+1031,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_IS_DIV));
	vcdp->chgBit(c+1032,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_IS_RS2_SIGNED));
	vcdp->chgBit(c+1033,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__execute_to_memory_IS_DIV));
	vcdp->chgBit(c+1034,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__memory_to_writeBack_IS_MUL));
	vcdp->chgQuad(c+1035,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__memory_to_writeBack_MUL_HH),34);
	vcdp->chgQuad(c+1037,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__memory_to_writeBack_MUL_LOW),52);
	vcdp->chgQuad(c+1039,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__execute_to_memory_MUL_HL),34);
	vcdp->chgQuad(c+1041,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__execute_to_memory_MUL_LH),34);
	vcdp->chgBus(c+1043,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__execute_to_memory_MUL_LL),32);
	vcdp->chgBus(c+1044,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__execute_to_memory_SHIFT_RIGHT),32);
	vcdp->chgBus(c+1045,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__execute_to_memory_SHIFT_CTRL),2);
	vcdp->chgBus(c+1046,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_SHIFT_CTRL),2);
	vcdp->chgBit(c+1047,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_SRC_LESS_UNSIGNED));
	vcdp->chgBit(c+1048,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_SRC2_FORCE_ZERO));
	vcdp->chgBit(c+1049,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_SRC_USE_SUB_LESS));
	vcdp->chgBus(c+1050,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_SRC2_CTRL),2);
	vcdp->chgBus(c+1051,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_SRC1_CTRL),2);
	vcdp->chgBus(c+1052,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_ALU_CTRL),2);
	vcdp->chgBus(c+1053,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_ALU_BITWISE_CTRL),2);
	vcdp->chgBus(c+1054,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__memory_to_writeBack_MEMORY_ADDRESS_LOW),2);
	vcdp->chgBit(c+1055,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__memory_to_writeBack_MEMORY_WR));
	vcdp->chgBit(c+1056,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__memory_to_writeBack_MEMORY_ENABLE));
	vcdp->chgBit(c+1057,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__execute_to_memory_MEMORY_ENABLE));
	vcdp->chgBit(c+1058,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_MEMORY_MANAGMENT));
	vcdp->chgBus(c+1059,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_RS2),32);
	vcdp->chgBit(c+1060,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_MEMORY_WR));
	vcdp->chgBit(c+1061,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_MEMORY_ENABLE));
	vcdp->chgBus(c+1062,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__memory_to_writeBack_PC),32);
	vcdp->chgBus(c+1063,((0xfffffffcU & vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT__decodeStage_mmuRsp_physicalAddress)),32);
	vcdp->chgBit(c+1064,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT__io_cpu_fetch_dataBypassValid_regNextWhen));
	vcdp->chgBus(c+1065,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT___zz_220_),32);
	vcdp->chgBus(c+1066,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT___zz_221_),32);
	...
	vcdp->chgArray(c+1067,(__Vtemp42),66);
	vcdp->chgQuad(c+1070,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__memory_DivPlugin_rs1),33);
	vcdp->chgBus(c+1072,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__memory_DivPlugin_rs2),32);
	vcdp->chgArray(c+1073,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__memory_DivPlugin_accumulator),65);
	vcdp->chgBit(c+1076,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__memory_DivPlugin_div_needRevert));
	vcdp->chgBit(c+1077,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__memory_DivPlugin_div_done));
	vcdp->chgBus(c+1078,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__memory_DivPlugin_div_result),32);
	vcdp->chgBus(c+1079,(((3U == (IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_BRANCH_CTRL))
			       ? vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_RS1
			       : vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_PC)),32);
	vcdp->chgBus(c+1080,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__CsrPlugin_mepc),32);
	vcdp->chgBit(c+1081,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__CsrPlugin_mip_MEIP));
	vcdp->chgBit(c+1082,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__CsrPlugin_mip_MTIP));
	vcdp->chgBit(c+1083,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__CsrPlugin_mip_MSIP));
	vcdp->chgBit(c+1084,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__CsrPlugin_mcause_interrupt));
	vcdp->chgBus(c+1085,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__CsrPlugin_mcause_exceptionCode),4);
	vcdp->chgBus(c+1086,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__CsrPlugin_mtval),32);
	vcdp->chgBus(c+1087,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__CsrPlugin_exceptionPortCtrl_exceptionContext_code),4);
	vcdp->chgBus(c+1088,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__CsrPlugin_exceptionPortCtrl_exceptionContext_badAddr),32);
	vcdp->chgBus(c+1089,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__CsrPlugin_interrupt_targetPrivilege),2);
	vcdp->chgBit(c+1090,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__DebugPlugin_firstCycle));
	vcdp->chgBit(c+1091,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__DebugPlugin_secondCycle));
	vcdp->chgBus(c+1092,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__DebugPlugin_busReadDataReg),32);
	vcdp->chgBus(c+1093,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_injectionPort_payload_regNext),32);
	vcdp->chgBus(c+1094,(((IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__execute_to_memory_ENV_CTRL)
			       ? ((IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__execute_to_memory_ENV_CTRL)
				   ? 0x58524554U : 0x3f3f3f3fU)
			       : 0x4e4f4e45U)),32);
	vcdp->chgBus(c+1095,(((IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_ENV_CTRL)
			       ? ((IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_ENV_CTRL)
				   ? 0x58524554U : 0x3f3f3f3fU)
			       : 0x4e4f4e45U)),32);
	vcdp->chgBus(c+1096,(((IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__memory_to_writeBack_ENV_CTRL)
			       ? ((IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__memory_to_writeBack_ENV_CTRL)
				   ? 0x58524554U : 0x3f3f3f3fU)
			       : 0x4e4f4e45U)),32);
	vcdp->chgBus(c+1097,(((2U & (IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_BRANCH_CTRL))
			       ? ((1U & (IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_BRANCH_CTRL))
				   ? 0x4a414c52U : 0x4a414c20U)
			       : ((1U & (IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_BRANCH_CTRL))
				   ? 0x42202020U : 0x494e4320U))),32);
	vcdp->chgBus(c+1098,(((2U & (IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_SRC2_CTRL))
			       ? ((1U & (IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_SRC2_CTRL))
				   ? 0x504320U : 0x494d53U)
			       : ((1U & (IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_SRC2_CTRL))
				   ? 0x494d49U : 0x525320U))),24);
	vcdp->chgQuad(c+1099,(((0U == (IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_ALU_CTRL))
			        ? VL_ULL(0x4144445f53554220)
			        : ((1U == (IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_ALU_CTRL))
				    ? VL_ULL(0x534c545f534c5455)
				    : ((2U == (IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_ALU_CTRL))
				        ? VL_ULL(0x4249545749534520)
				        : VL_ULL(0x3f3f3f3f3f3f3f3f))))),64);
	vcdp->chgQuad(c+1101,(((0U == (IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_ALU_BITWISE_CTRL))
			        ? VL_ULL(0x584f525f31)
			        : ((1U == (IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_ALU_BITWISE_CTRL))
				    ? VL_ULL(0x4f525f3120)
				    : ((2U == (IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_ALU_BITWISE_CTRL))
				        ? VL_ULL(0x414e445f31)
				        : VL_ULL(0x3f3f3f3f3f))))),40);
	vcdp->chgBus(c+1103,(((IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_ENV_CTRL)
			       ? ((IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_ENV_CTRL)
				   ? 0x58524554U : 0x3f3f3f3fU)
			       : 0x4e4f4e45U)),32);
	vcdp->chgBus(c+1104,(((IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__execute_to_memory_ENV_CTRL)
			       ? ((IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__execute_to_memory_ENV_CTRL)
				   ? 0x58524554U : 0x3f3f3f3fU)
			       : 0x4e4f4e45U)),32);
	vcdp->chgBus(c+1105,(((IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__memory_to_writeBack_ENV_CTRL)
			       ? ((IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__memory_to_writeBack_ENV_CTRL)
				   ? 0x58524554U : 0x3f3f3f3fU)
			       : 0x4e4f4e45U)),32);
	vcdp->chgBus(c+1106,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT__lineLoader_address),32);
	vcdp->chgBus(c+1107,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT__lineLoader_flushCounter),4);
	vcdp->chgBus(c+1108,((7U & ((8U & (IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT__lineLoader_flushCounter))
				     ? (vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT__lineLoader_address 
					>> 5U) : (IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT__lineLoader_flushCounter)))),3);
	vcdp->chgBit(c+1109,((1U & ((IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT__lineLoader_flushCounter) 
				    >> 3U))));
	vcdp->chgBus(c+1110,((0xffffffU & (vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT__lineLoader_address 
					   >> 8U))),24);
	vcdp->chgBit(c+1111,((1U & vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT___zz_11_)));
	vcdp->chgBit(c+1112,((1U & (vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT___zz_11_ 
				    >> 1U))));
	vcdp->chgBus(c+1113,((0xffffffU & (vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT___zz_11_ 
					   >> 2U))),24);
	vcdp->chgBus(c+1114,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT___zz_12_),32);
	vcdp->chgBit(c+1115,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT__decodeStage_mmuRsp_isIoAccess));
	vcdp->chgBit(c+1116,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT__decodeStage_mmuRsp_allowRead));
	vcdp->chgBit(c+1117,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT__decodeStage_mmuRsp_allowWrite));
	vcdp->chgBit(c+1118,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT__decodeStage_mmuRsp_allowExecute));
	vcdp->chgBit(c+1119,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT__decodeStage_hit_tags_0_valid));
	vcdp->chgBus(c+1120,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT__decodeStage_hit_tags_0_address),24);
	vcdp->chgBit(c+1121,(((IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT__decodeStage_hit_tags_0_valid) 
			      & (vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT__decodeStage_hit_tags_0_address 
				 == (0xffffffU & (vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT__decodeStage_mmuRsp_physicalAddress 
						  >> 8U))))));
	vcdp->chgBus(c+1122,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT___zz_10_),32);
	vcdp->chgBus(c+1123,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT__io_cpu_fetch_dataBypass_regNextWhen),32);
	vcdp->chgBus(c+1124,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT__ways_0_tags[0]),26);
	vcdp->chgBus(c+1125,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT__ways_0_tags[1]),26);
	vcdp->chgBus(c+1126,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT__ways_0_tags[2]),26);
	vcdp->chgBus(c+1127,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT__ways_0_tags[3]),26);
	vcdp->chgBus(c+1128,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT__ways_0_tags[4]),26);
	vcdp->chgBus(c+1129,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT__ways_0_tags[5]),26);
	vcdp->chgBus(c+1130,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT__ways_0_tags[6]),26);
	vcdp->chgBus(c+1131,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT__ways_0_tags[7]),26);
	vcdp->chgBit(c+1132,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__dataCache_1___DOT__tagsWriteLastCmd_valid));
	vcdp->chgBit(c+1133,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__dataCache_1___DOT__tagsWriteLastCmd_payload_way));
	vcdp->chgBus(c+1134,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__dataCache_1___DOT__tagsWriteLastCmd_payload_address),3);
	...
	vcdp->chgBus(c+1137,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__dataCache_1___DOT__tagsWriteLastCmd_payload_data_address),24);
	vcdp->chgBit(c+1138,((1U & vlSymsp->TOP__Briey__axi_core_cpu.__PVT__dataCache_1___DOT___zz_10_)));
	vcdp->chgBit(c+1139,((1U & (vlSymsp->TOP__Briey__axi_core_cpu.__PVT__dataCache_1___DOT___zz_10_ 
				    >> 1U))));
	vcdp->chgBus(c+1140,((0xffffffU & (vlSymsp->TOP__Briey__axi_core_cpu.__PVT__dataCache_1___DOT___zz_10_ 
					   >> 2U))),24);
	vcdp->chgBus(c+1141,((((IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__dataCache_1___DOT___zz_27_) 
	...
	vcdp->chgBus(c+1153,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__dataCache_1___DOT__stageB_tagsReadRsp_0_address),24);
	...
	vcdp->chgBus(c+1158,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__dataCache_1___DOT__ways_0_tags[0]),26);
	vcdp->chgBus(c+1159,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__dataCache_1___DOT__ways_0_tags[1]),26);
	vcdp->chgBus(c+1160,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__dataCache_1___DOT__ways_0_tags[2]),26);
	vcdp->chgBus(c+1161,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__dataCache_1___DOT__ways_0_tags[3]),26);
	vcdp->chgBus(c+1162,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__dataCache_1___DOT__ways_0_tags[4]),26);
	vcdp->chgBus(c+1163,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__dataCache_1___DOT__ways_0_tags[5]),26);
	vcdp->chgBus(c+1164,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__dataCache_1___DOT__ways_0_tags[6]),26);
	vcdp->chgBus(c+1165,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__dataCache_1___DOT__ways_0_tags[7]),26);
    }
}
...
void VBriey::traceChgThis__32(VBriey__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBit(c+1166,((((IData)(vlSymsp->TOP__Briey.__PVT__axi_ram__DOT___zz_6_) 
			       & (IData)(vlSymsp->TOP__Briey.__PVT__axi_ram__DOT___zz_12_)) 
			      & (IData)(vlSymsp->TOP__Briey.__PVT__axi_ram__DOT___zz_7_))));
	vcdp->chgBus(c+1167,(((IData)(vlSymsp->TOP__Briey.__PVT__axi_ram__DOT__unburstify_buffer_valid)
	...
	vcdp->chgBus(c+1170,(((IData)(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__unburstify_buffer_valid)
			       ? (IData)(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__unburstify_buffer_transaction_size)
	...
	vcdp->chgBus(c+1172,((0xffffU & ((IData)(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT___zz_3_)
					  ? (vlSymsp->TOP__Briey.__PVT___zz_80_ 
					     >> 0x10U)
					  : vlSymsp->TOP__Briey.__PVT___zz_80_))),16);
	vcdp->chgBus(c+1173,((3U & ((IData)(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT___zz_3_)
				     ? ((IData)(vlSymsp->TOP__Briey.__PVT___zz_81_) 
					>> 2U) : (IData)(vlSymsp->TOP__Briey.__PVT___zz_81_)))),2);
	vcdp->chgBit(c+1174,(((IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT___zz_117_) 
			      & (~ (IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_s1_tightlyCoupledHit)))));
	vcdp->chgBus(c+1175,(((0x38U & (vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT__lineLoader_address 
...
void VBriey::traceChgThis__33(VBriey__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBus(c+1176,(((0U == (3U & (vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_INSTRUCTION 
					    >> 0xcU)))
	...
	vcdp->chgBit(c+1177,((((0xffffffU & (vlSymsp->TOP__Briey__axi_core_cpu.__PVT__execute_to_memory_REGFILE_WRITE_DATA 
					     >> 8U)) 
...
void VBriey::traceChgThis__34(VBriey__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBit(c+1178,(((IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__memory_arbitration_isValid) 
			      & (IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__execute_to_memory_MEMORY_ENABLE))));
	vcdp->chgBit(c+1179,((((IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__execute_arbitration_isValid) 
			       & (IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_IS_CSR)) 
...
void VBriey::traceChgThis__35(VBriey__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBit(c+1181,(vlSymsp->TOP__Briey.__PVT__jtagBridge_1___DOT__jtag_tap_tdoUnbufferd_regNext));
    }
}
...
void VBriey::traceChgThis__36(VBriey__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBus(c+1182,(vlSymsp->TOP__Briey.__PVT__jtagBridge_1___DOT__jtag_tap_instruction),4);
	vcdp->chgBus(c+1183,(vlSymsp->TOP__Briey.__PVT__jtagBridge_1___DOT__jtag_tap_instructionShift),4);
	vcdp->chgBit(c+1184,(vlSymsp->TOP__Briey.__PVT__jtagBridge_1___DOT__jtag_tap_bypass));
	vcdp->chgBit(c+1185,((1U == (IData)(vlSymsp->TOP__Briey.__PVT__jtagBridge_1___DOT__jtag_tap_instruction))));
	vcdp->chgBus(c+1186,(vlSymsp->TOP__Briey.__PVT__jtagBridge_1___DOT__jtag_idcodeArea_shifter),32);
	vcdp->chgBit(c+1187,((2U == (IData)(vlSymsp->TOP__Briey.__PVT__jtagBridge_1___DOT__jtag_tap_instruction))));
	vcdp->chgBit(c+1188,((3U == (IData)(vlSymsp->TOP__Briey.__PVT__jtagBridge_1___DOT__jtag_tap_instruction))));
	vcdp->chgQuad(c+1189,(vlSymsp->TOP__Briey.__PVT__jtagBridge_1___DOT__jtag_readArea_shifter),34);
	vcdp->chgBit(c+1191,(vlSymsp->TOP__Briey.__PVT__jtagBridge_1___DOT__flowCCByToggle_1___DOT__inputArea_data_fragment));
    }
}
...
void VBriey::traceChgThis__37(VBriey__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBit(c+1192,((1U & (~ (IData)(vlSymsp->TOP__Briey.__PVT__systemDebugger_1___DOT__dispatcher_dataLoaded)))));
	vcdp->chgBit(c+1193,(vlSymsp->TOP__Briey.__PVT__systemDebugger_1___DOT__dispatcher_dataLoaded));
	vcdp->chgBit(c+1194,(vlSymsp->TOP__Briey.__PVT__systemDebugger_1___DOT__dispatcher_headerLoaded));
	vcdp->chgBus(c+1195,(vlSymsp->TOP__Briey.__PVT__systemDebugger_1___DOT__dispatcher_counter),3);
	vcdp->chgBit(c+1196,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__DebugPlugin_haltIt));
	vcdp->chgBit(c+1197,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__DebugPlugin_stepIt));
	vcdp->chgBit(c+1198,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__DebugPlugin_godmode));
	vcdp->chgBit(c+1199,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__DebugPlugin_haltedByBreak));
    }
}
...
void VBriey::traceChgThis__38(VBriey__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBus(c+1200,(vlSymsp->TOP__Briey.__PVT__axi_gpioACtrl__DOT__io_gpio_writeEnable_driver),32);
	vcdp->chgBus(c+1201,(vlSymsp->TOP__Briey.__PVT__axi_gpioBCtrl__DOT__io_gpio_writeEnable_driver),32);
	vcdp->chgBit(c+1202,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___DOT__tx__DOT__stateMachine_txd_regNext));
	vcdp->chgBit(c+1203,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__vga__DOT__hSyncDelay));
	vcdp->chgBit(c+1204,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__vga__DOT__vSyncDelay));
	vcdp->chgBit(c+1205,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__vga__DOT__videoOn));
	vcdp->chgBit(c+1206,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT___zz_11_));
	vcdp->chgBit(c+1207,(vlSymsp->TOP__Briey.__PVT___zz_11_));
	vcdp->chgBit(c+1208,(vlSymsp->TOP__Briey.__PVT___zz_18_));
	vcdp->chgBit(c+1209,((1U & (~ (IData)(vlSymsp->TOP__Briey.__PVT___zz_25_)))));
	vcdp->chgBit(c+1210,(((IData)(vlSymsp->TOP__Briey.__PVT___zz_18_) 
			      | (IData)(vlSymsp->TOP__Briey.__PVT___zz_25_))));
	vcdp->chgBit(c+1211,(vlSymsp->TOP__Briey.__PVT___zz_55_));
	vcdp->chgBit(c+1212,(vlSymsp->TOP__Briey.__PVT__axi_gpu_io_axiram_ar_halfPipe_regs_ready));
	vcdp->chgBit(c+1213,(vlSymsp->TOP__Briey.__PVT__axi_ram_io_axi_arbiter_io_output_arw_halfPipe_regs_ready));
	vcdp->chgBit(c+1214,(vlSymsp->TOP__Briey.__PVT___zz_68_));
	vcdp->chgBit(c+1215,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl_io_axi_arbiter_io_output_arw_halfPipe_regs_ready));
	vcdp->chgBit(c+1216,(vlSymsp->TOP__Briey.__PVT___zz_79_));
	vcdp->chgBit(c+1217,(vlSymsp->TOP__Briey.__PVT__axi_apbBridge_io_axi_arbiter_io_output_arw_halfPipe_regs_ready));
	vcdp->chgBit(c+1218,(vlSymsp->TOP__Briey.__PVT__axi_apbBridge_io_axi_arbiter_io_output_w_halfPipe_regs_ready));
	vcdp->chgBit(c+1219,(vlSymsp->TOP__Briey.__PVT__axi_ram__DOT__unburstify_buffer_valid));
	vcdp->chgBit(c+1220,(vlSymsp->TOP__Briey.__PVT__axi_ram__DOT___zz_6_));
	vcdp->chgBit(c+1221,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__unburstify_buffer_valid));
	vcdp->chgBus(c+1222,((0x3ffU & ((0x30dU == (IData)(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__refresh_counter_value))
					 ? 0U : ((IData)(1U) 
						 + (IData)(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__refresh_counter_value))))),10);
	vcdp->chgBus(c+1223,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__refresh_counter_value),10);
	vcdp->chgBit(c+1224,((0x30dU == (IData)(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__refresh_counter_value))));
	vcdp->chgBit(c+1225,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__refresh_pending));
	vcdp->chgBus(c+1226,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__powerup_counter),14);
	vcdp->chgBit(c+1227,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__powerup_done));
	vcdp->chgBit(c+1228,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__frontend_banks_0_active));
	vcdp->chgBit(c+1229,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__frontend_banks_1_active));
	vcdp->chgBit(c+1230,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__frontend_banks_2_active));
	vcdp->chgBit(c+1231,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__frontend_banks_3_active));
	vcdp->chgBus(c+1232,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__frontend_state),2);
	vcdp->chgBus(c+1233,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__frontend_bootRefreshCounter_value),3);
	vcdp->chgBit(c+1234,((7U == (IData)(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__frontend_bootRefreshCounter_value))));
	vcdp->chgBit(c+1235,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT___zz_9_));
	vcdp->chgBit(c+1236,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__chip_sdramCkeInternal_regNext));
	vcdp->chgBit(c+1237,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__bubbleInserter_timings_read_counter));
	vcdp->chgBit(c+1238,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__bubbleInserter_timings_read_counter));
	vcdp->chgBus(c+1239,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__bubbleInserter_timings_write_counter),3);
	vcdp->chgBit(c+1240,((0U != (IData)(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__bubbleInserter_timings_write_counter))));
	vcdp->chgBus(c+1241,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__bubbleInserter_timings_banks_0_precharge_counter),3);
	vcdp->chgBit(c+1242,((0U != (IData)(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__bubbleInserter_timings_banks_0_precharge_counter))));
	vcdp->chgBus(c+1243,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__bubbleInserter_timings_banks_0_active_counter),3);
	vcdp->chgBit(c+1244,((0U != (IData)(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__bubbleInserter_timings_banks_0_active_counter))));
	vcdp->chgBus(c+1245,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__bubbleInserter_timings_banks_1_precharge_counter),3);
	vcdp->chgBit(c+1246,((0U != (IData)(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__bubbleInserter_timings_banks_1_precharge_counter))));
	vcdp->chgBus(c+1247,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__bubbleInserter_timings_banks_1_active_counter),3);
	vcdp->chgBit(c+1248,((0U != (IData)(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__bubbleInserter_timings_banks_1_active_counter))));
	vcdp->chgBus(c+1249,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__bubbleInserter_timings_banks_2_precharge_counter),3);
	vcdp->chgBit(c+1250,((0U != (IData)(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__bubbleInserter_timings_banks_2_precharge_counter))));
	vcdp->chgBus(c+1251,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__bubbleInserter_timings_banks_2_active_counter),3);
	vcdp->chgBit(c+1252,((0U != (IData)(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__bubbleInserter_timings_banks_2_active_counter))));
	vcdp->chgBus(c+1253,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__bubbleInserter_timings_banks_3_precharge_counter),3);
	vcdp->chgBit(c+1254,((0U != (IData)(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__bubbleInserter_timings_banks_3_precharge_counter))));
	vcdp->chgBus(c+1255,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__bubbleInserter_timings_banks_3_active_counter),3);
	vcdp->chgBit(c+1256,((0U != (IData)(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__bubbleInserter_timings_banks_3_active_counter))));
	vcdp->chgBit(c+1257,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT___zz_20_));
	vcdp->chgBit(c+1258,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT___zz_21_));
	vcdp->chgBit(c+1259,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT___zz_22_));
	vcdp->chgBit(c+1260,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT___zz_23_));
	vcdp->chgBit(c+1261,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT___zz_24_));
	vcdp->chgBit(c+1262,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__chip_sdramCkeInternal));
	vcdp->chgBit(c+1263,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__chip_backupIn_fifo__DOT__pushPtr_value));
	vcdp->chgBit(c+1264,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__chip_backupIn_fifo__DOT__pushPtr_value));
	vcdp->chgBit(c+1265,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__chip_backupIn_fifo__DOT__popPtr_value));
	vcdp->chgBit(c+1266,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__chip_backupIn_fifo__DOT__popPtr_value));
	vcdp->chgBit(c+1267,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__chip_backupIn_fifo__DOT__risingOccupancy));
	vcdp->chgBit(c+1268,((1U & ((IData)(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__chip_backupIn_fifo__DOT__pushPtr_value) 
				    - (IData)(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT__chip_backupIn_fifo__DOT__popPtr_value)))));
	vcdp->chgBus(c+1269,(vlSymsp->TOP__Briey.__PVT__axi_apbBridge__DOT__phase),2);
	vcdp->chgQuad(c+1270,(((0U == (IData)(vlSymsp->TOP__Briey.__PVT__axi_apbBridge__DOT__phase))
				    ...
				    : ((2U == (IData)(vlSymsp->TOP__Briey.__PVT__axi_apbBridge__DOT__phase))
				        ...
				        : VL_ULL(0x3f3f3f3f3f3f3f3f))))),64);
	vcdp->chgBus(c+1272,(vlSymsp->TOP__Briey.__PVT__axi_timerCtrl__DOT__timerABridge_ticksEnable),2);
	vcdp->chgBit(c+1273,(vlSymsp->TOP__Briey.__PVT__axi_timerCtrl__DOT__timerABridge_clearsEnable));
	vcdp->chgBus(c+1274,(vlSymsp->TOP__Briey.__PVT__axi_timerCtrl__DOT__timerBBridge_ticksEnable),3);
	vcdp->chgBus(c+1275,(vlSymsp->TOP__Briey.__PVT__axi_timerCtrl__DOT__timerBBridge_clearsEnable),2);
	vcdp->chgBus(c+1276,(vlSymsp->TOP__Briey.__PVT__axi_timerCtrl__DOT__timerCBridge_ticksEnable),3);
	vcdp->chgBus(c+1277,(vlSymsp->TOP__Briey.__PVT__axi_timerCtrl__DOT__timerCBridge_clearsEnable),2);
	vcdp->chgBus(c+1278,(vlSymsp->TOP__Briey.__PVT__axi_timerCtrl__DOT__timerDBridge_ticksEnable),3);
	vcdp->chgBus(c+1279,(vlSymsp->TOP__Briey.__PVT__axi_timerCtrl__DOT__timerDBridge_clearsEnable),2);
	vcdp->chgBus(c+1280,(vlSymsp->TOP__Briey.__PVT__axi_timerCtrl__DOT__interruptCtrl_1___05Fio_masks_driver),4);
	vcdp->chgBit(c+1281,(vlSymsp->TOP__Briey.__PVT__axi_timerCtrl__DOT__timerA__DOT__inhibitFull));
	vcdp->chgBit(c+1282,(vlSymsp->TOP__Briey.__PVT__axi_timerCtrl__DOT__timerB__DOT__inhibitFull));
	vcdp->chgBit(c+1283,(vlSymsp->TOP__Briey.__PVT__axi_timerCtrl__DOT__timerC__DOT__inhibitFull));
	vcdp->chgBit(c+1284,(vlSymsp->TOP__Briey.__PVT__axi_timerCtrl__DOT__timerD__DOT__inhibitFull));
	vcdp->chgBus(c+1285,(vlSymsp->TOP__Briey.__PVT__axi_timerCtrl__DOT__interruptCtrl_1___DOT__pendings),4);
	vcdp->chgBit(c+1286,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___DOT__rx__DOT__stateMachine_validReg));
	vcdp->chgBus(c+1287,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__bridge_uartConfigReg_clockDivider),20);
	vcdp->chgBit(c+1288,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__bridge_interruptCtrl_writeIntEnable));
	vcdp->chgBit(c+1289,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__bridge_interruptCtrl_readIntEnable));
	vcdp->chgBus(c+1290,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___DOT__clockDivider_counter),20);
	vcdp->chgBit(c+1291,((0U == vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___DOT__clockDivider_counter)));
	vcdp->chgBus(c+1292,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___DOT__tx__DOT__clockDivider_counter_value),3);
	vcdp->chgBit(c+1293,((7U == (IData)(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___DOT__tx__DOT__clockDivider_counter_value))));
	vcdp->chgBus(c+1294,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___DOT__tx__DOT__stateMachine_state),3);
	vcdp->chgBit(c+1295,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___DOT__rx__DOT__bufferCC_8___DOT__buffers_1));
	vcdp->chgBit(c+1296,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___DOT__rx__DOT__sampler_samples_1));
	vcdp->chgBit(c+1297,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___DOT__rx__DOT__sampler_samples_2));
	vcdp->chgBit(c+1298,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___DOT__rx__DOT__sampler_samples_3));
	vcdp->chgBit(c+1299,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___DOT__rx__DOT__sampler_samples_4));
	vcdp->chgBit(c+1300,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___DOT__rx__DOT__sampler_value));
	vcdp->chgBit(c+1301,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___DOT__rx__DOT__sampler_tick));
	vcdp->chgBus(c+1302,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___DOT__rx__DOT__stateMachine_state),3);
	vcdp->chgBit(c+1303,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___DOT__rx__DOT__bufferCC_8___DOT__buffers_0));
	vcdp->chgBus(c+1304,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__bridge_write_streamUnbuffered_queueWithOccupancy__DOT__logic_pushPtr_value),4);
	vcdp->chgBit(c+1305,((0xfU == (IData)(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__bridge_write_streamUnbuffered_queueWithOccupancy__DOT__logic_pushPtr_value))));
	vcdp->chgBus(c+1306,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__bridge_write_streamUnbuffered_queueWithOccupancy__DOT__logic_popPtr_value),4);
	vcdp->chgBit(c+1307,((0xfU == (IData)(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__bridge_write_streamUnbuffered_queueWithOccupancy__DOT__logic_popPtr_value))));
	vcdp->chgBit(c+1308,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__bridge_write_streamUnbuffered_queueWithOccupancy__DOT__logic_risingOccupancy));
	vcdp->chgBus(c+1309,((0xfU & ((IData)(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__bridge_write_streamUnbuffered_queueWithOccupancy__DOT__logic_pushPtr_value) 
	...
	vcdp->chgBus(c+1310,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___05Fio_read_queueWithOccupancy__DOT__logic_pushPtr_value),4);
	vcdp->chgBit(c+1311,((0xfU == (IData)(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___05Fio_read_queueWithOccupancy__DOT__logic_pushPtr_value))));
	vcdp->chgBus(c+1312,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___05Fio_read_queueWithOccupancy__DOT__logic_popPtr_value),4);
	vcdp->chgBit(c+1313,((0xfU == (IData)(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___05Fio_read_queueWithOccupancy__DOT__logic_popPtr_value))));
	vcdp->chgBit(c+1314,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___05Fio_read_queueWithOccupancy__DOT__logic_risingOccupancy));
	vcdp->chgBus(c+1315,((0xfU & ((IData)(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___05Fio_read_queueWithOccupancy__DOT__logic_pushPtr_value) 
				      - (IData)(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___05Fio_read_queueWithOccupancy__DOT__logic_popPtr_value)))),4);
	vcdp->chgBus(c+1316,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__bresLine__DOT__x),10);
	vcdp->chgBus(c+1317,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__bresLine__DOT__y),9);
	vcdp->chgBus(c+1318,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__storeRadius),10);
	vcdp->chgBit(c+1319,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__trigger));
	vcdp->chgBus(c+1320,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__counter),8);
	vcdp->chgBus(c+1321,((0xffU & ((IData)(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__counter) 
				       - (IData)(2U)))),8);
	vcdp->chgBit(c+1322,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__switchVGA));
	vcdp->chgBit(c+1323,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__vga__DOT__vga__DOT__vgaArea_hSync));
	vcdp->chgBit(c+1324,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__vga__DOT__vga__DOT__vgaArea_vSync));
	vcdp->chgBus(c+1325,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__vga__DOT__vga__DOT__vgaArea_hCounter),10);
	vcdp->chgBus(c+1326,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__vga__DOT__vga__DOT__vgaArea_vCounter),10);
	vcdp->chgBit(c+1327,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__vga__DOT__switchBuffer));
	vcdp->chgBit(c+1328,((0x31fU == (IData)(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__vga__DOT__vga__DOT__vgaArea_hCounter))));
	vcdp->chgBit(c+1329,((0x20cU == (IData)(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__vga__DOT__vga__DOT__vgaArea_vCounter))));
	vcdp->chgBus(c+1330,((((IData)(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__switchVGA) 
			       << 0x13U) | ((0x7fc00U 
	...
	vcdp->chgBus(c+1331,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__bresLine__DOT__dx),11);
	vcdp->chgBus(c+1332,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__bresLine__DOT__dy),10);
	vcdp->chgBit(c+1333,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__bresLine__DOT__down));
	vcdp->chgBit(c+1334,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__bresLine__DOT__right));
	vcdp->chgBus(c+1335,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__bresLine__DOT__err),20);
	vcdp->chgBus(c+1336,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__bresLine__DOT__x2),10);
	vcdp->chgBus(c+1337,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__bresLine__DOT__y2),9);
	vcdp->chgBus(c+1338,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__bresLine__DOT__breshamSM_stateReg),3);
	vcdp->chgBus(c+1339,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__bresCircle__DOT__x),12);
	vcdp->chgBus(c+1340,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__bresCircle__DOT__y),11);
	vcdp->chgBus(c+1341,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__bresCircle__DOT__err),21);
	vcdp->chgBus(c+1342,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__bresCircle__DOT__rTemp),21);
	vcdp->chgBus(c+1343,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__bresCircle__DOT__x1),11);
	vcdp->chgBus(c+1344,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__bresCircle__DOT__y1),10);
	vcdp->chgBus(c+1345,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__bresCircle__DOT__BreshamCircSM_stateReg),3);
	vcdp->chgBus(c+1346,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__fillRect__DOT__fill_stateReg),2);
	...
	__Vtemp52[2U] = ((0U == (IData)(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__fillRect__DOT__fill_stateReg))
			  ? 0x62U : ((1U == (IData)(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__fillRect__DOT__fill_stateReg))
				      ? 0x66U : ((2U 
						  ...
						  ? 0x66U
						  : 0x3fU)));
	vcdp->chgArray(c+1347,(__Vtemp52),72);
	vcdp->chgBit(c+1350,(vlSymsp->TOP__Briey.__PVT__streamFork_5___DOT__linkEnable_0));
	vcdp->chgBit(c+1351,(vlSymsp->TOP__Briey.__PVT__streamFork_5___DOT__linkEnable_1));
	vcdp->chgBit(c+1352,((1U & (~ (IData)(vlSymsp->TOP__Briey.__PVT__axi_core_iBus_decoder__DOT__errorSlave__DOT__sendRsp)))));
	vcdp->chgBit(c+1353,(vlSymsp->TOP__Briey.__PVT__axi_core_iBus_decoder__DOT__errorSlave__DOT__sendRsp));
	vcdp->chgBus(c+1354,(vlSymsp->TOP__Briey.__PVT__axi_core_iBus_decoder__DOT__pendingCmdCounter_value),3);
	vcdp->chgBus(c+1355,(vlSymsp->TOP__Briey.__PVT__axi_core_iBus_decoder__DOT__pendingSels),2);
	vcdp->chgBit(c+1356,(vlSymsp->TOP__Briey.__PVT__axi_core_iBus_decoder__DOT__pendingError));
	vcdp->chgBit(c+1357,((1U & ((IData)(vlSymsp->TOP__Briey.__PVT__axi_core_iBus_decoder__DOT__pendingSels) 
				    >> 1U))));
	vcdp->chgBit(c+1358,(vlSymsp->TOP__Briey.__PVT__axi_core_dBus_decoder__DOT__errorSlave__DOT__consumeData));
	vcdp->chgBit(c+1359,(vlSymsp->TOP__Briey.__PVT__axi_core_dBus_decoder__DOT__errorSlave__DOT__sendWriteRsp));
	vcdp->chgBit(c+1360,(vlSymsp->TOP__Briey.__PVT__axi_core_dBus_decoder__DOT__errorSlave__DOT__sendReadRsp));
	vcdp->chgBus(c+1361,(vlSymsp->TOP__Briey.__PVT__axi_core_dBus_decoder__DOT__pendingCmdCounter),3);
	vcdp->chgBus(c+1362,(vlSymsp->TOP__Briey.__PVT__axi_core_dBus_decoder__DOT__pendingDataCounter_value),3);
	vcdp->chgBus(c+1363,(vlSymsp->TOP__Briey.__PVT__axi_core_dBus_decoder__DOT__pendingSels),4);
	vcdp->chgBit(c+1364,(vlSymsp->TOP__Briey.__PVT__axi_core_dBus_decoder__DOT__pendingError));
	vcdp->chgBit(c+1365,((0U != (IData)(vlSymsp->TOP__Briey.__PVT__axi_core_dBus_decoder__DOT__pendingDataCounter_value))));
	vcdp->chgBit(c+1366,((1U & (~ (IData)(vlSymsp->TOP__Briey.__PVT__axi_gpu_io_axiram_decoder__DOT__errorSlave__DOT__sendRsp)))));
	vcdp->chgBit(c+1367,(vlSymsp->TOP__Briey.__PVT__axi_gpu_io_axiram_decoder__DOT__errorSlave__DOT__sendRsp));
	vcdp->chgBus(c+1368,(vlSymsp->TOP__Briey.__PVT__axi_gpu_io_axiram_decoder__DOT__pendingCmdCounter_value),3);
	vcdp->chgBit(c+1369,(vlSymsp->TOP__Briey.__PVT__axi_gpu_io_axiram_decoder__DOT__pendingSels));
	vcdp->chgBit(c+1370,(vlSymsp->TOP__Briey.__PVT__axi_gpu_io_axiram_decoder__DOT__pendingError));
	vcdp->chgBit(c+1371,(vlSymsp->TOP__Briey.__PVT___zz_42_));
	vcdp->chgBit(c+1372,(vlSymsp->TOP__Briey.__PVT___zz_54_));
	vcdp->chgBit(c+1373,((1U & (~ (IData)(vlSymsp->TOP__Briey.__PVT___zz_64_)))));
	vcdp->chgBit(c+1374,(vlSymsp->TOP__Briey.__PVT__axi_ram_io_axi_arbiter__DOT__cmdArbiter__DOT__locked));
	vcdp->chgBit(c+1375,(vlSymsp->TOP__Briey.__PVT__axi_ram_io_axi_arbiter__DOT__cmdArbiter__DOT__maskLocked_0));
	vcdp->chgBit(c+1376,(vlSymsp->TOP__Briey.__PVT__axi_ram_io_axi_arbiter__DOT__cmdArbiter__DOT__maskLocked_1));
	vcdp->chgBit(c+1377,(vlSymsp->TOP__Briey.__PVT__axi_ram_io_axi_arbiter__DOT__streamFork_5___DOT__linkEnable_0));
	vcdp->chgBit(c+1378,(vlSymsp->TOP__Briey.__PVT__axi_ram_io_axi_arbiter__DOT__streamFork_5___DOT__linkEnable_1));
	vcdp->chgBus(c+1379,(vlSymsp->TOP__Briey.__PVT__axi_ram_io_axi_arbiter__DOT__streamFifoLowLatency_5___DOT__pushPtr_value),2);
	vcdp->chgBit(c+1380,((3U == (IData)(vlSymsp->TOP__Briey.__PVT__axi_ram_io_axi_arbiter__DOT__streamFifoLowLatency_5___DOT__pushPtr_value))));
	vcdp->chgBus(c+1381,(vlSymsp->TOP__Briey.__PVT__axi_ram_io_axi_arbiter__DOT__streamFifoLowLatency_5___DOT__popPtr_value),2);
	vcdp->chgBit(c+1382,((3U == (IData)(vlSymsp->TOP__Briey.__PVT__axi_ram_io_axi_arbiter__DOT__streamFifoLowLatency_5___DOT__popPtr_value))));
	vcdp->chgBit(c+1383,(vlSymsp->TOP__Briey.__PVT__axi_ram_io_axi_arbiter__DOT__streamFifoLowLatency_5___DOT__risingOccupancy));
	vcdp->chgBus(c+1384,((3U & ((IData)(vlSymsp->TOP__Briey.__PVT__axi_ram_io_axi_arbiter__DOT__streamFifoLowLatency_5___DOT__pushPtr_value) 
				    - (IData)(vlSymsp->TOP__Briey.__PVT__axi_ram_io_axi_arbiter__DOT__streamFifoLowLatency_5___DOT__popPtr_value)))),2);
	vcdp->chgBit(c+1385,(vlSymsp->TOP__Briey.__PVT___zz_39_));
	vcdp->chgBit(c+1386,(vlSymsp->TOP__Briey.__PVT___zz_61_));
	vcdp->chgBit(c+1387,(vlSymsp->TOP__Briey.__PVT___zz_45_));
	vcdp->chgBit(c+1388,((1U & (~ (IData)(vlSymsp->TOP__Briey.__PVT___zz_75_)))));
	vcdp->chgBit(c+1389,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl_io_axi_arbiter__DOT__cmdArbiter__DOT__locked));
	vcdp->chgBit(c+1390,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl_io_axi_arbiter__DOT__cmdArbiter__DOT__maskLocked_0));
	vcdp->chgBit(c+1391,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl_io_axi_arbiter__DOT__cmdArbiter__DOT__maskLocked_1));
	vcdp->chgBit(c+1392,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl_io_axi_arbiter__DOT__cmdArbiter__DOT__maskLocked_2));
	vcdp->chgBit(c+1393,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl_io_axi_arbiter__DOT__streamFork_5___DOT__linkEnable_0));
	vcdp->chgBit(c+1394,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl_io_axi_arbiter__DOT__streamFork_5___DOT__linkEnable_1));
	vcdp->chgBus(c+1395,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl_io_axi_arbiter__DOT__streamFifoLowLatency_5___DOT__pushPtr_value),2);
	vcdp->chgBit(c+1396,((3U == (IData)(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl_io_axi_arbiter__DOT__streamFifoLowLatency_5___DOT__pushPtr_value))));
	vcdp->chgBus(c+1397,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl_io_axi_arbiter__DOT__streamFifoLowLatency_5___DOT__popPtr_value),2);
	vcdp->chgBit(c+1398,((3U == (IData)(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl_io_axi_arbiter__DOT__streamFifoLowLatency_5___DOT__popPtr_value))));
	vcdp->chgBit(c+1399,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl_io_axi_arbiter__DOT__streamFifoLowLatency_5___DOT__risingOccupancy));
	vcdp->chgBus(c+1400,((3U & ((IData)(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl_io_axi_arbiter__DOT__streamFifoLowLatency_5___DOT__pushPtr_value) 
				    - (IData)(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl_io_axi_arbiter__DOT__streamFifoLowLatency_5___DOT__popPtr_value)))),2);
	vcdp->chgBit(c+1401,(vlSymsp->TOP__Briey.__PVT___zz_48_));
	vcdp->chgBit(c+1402,(vlSymsp->TOP__Briey.__PVT__axi_apbBridge_io_axi_arbiter__DOT__cmdArbiter__DOT__locked));
	vcdp->chgBit(c+1403,(vlSymsp->TOP__Briey.__PVT__axi_apbBridge_io_axi_arbiter__DOT__cmdArbiter__DOT__maskLocked_0));
	vcdp->chgBit(c+1404,(vlSymsp->TOP__Briey.__PVT__axi_apbBridge_io_axi_arbiter__DOT__streamFork_5___DOT__linkEnable_0));
	vcdp->chgBit(c+1405,(vlSymsp->TOP__Briey.__PVT__axi_apbBridge_io_axi_arbiter__DOT__streamFork_5___DOT__linkEnable_1));
	vcdp->chgBus(c+1406,(vlSymsp->TOP__Briey.__PVT__axi_apbBridge_io_axi_arbiter__DOT__streamFifoLowLatency_5___DOT__pushPtr_value),2);
	vcdp->chgBit(c+1407,((3U == (IData)(vlSymsp->TOP__Briey.__PVT__axi_apbBridge_io_axi_arbiter__DOT__streamFifoLowLatency_5___DOT__pushPtr_value))));
	vcdp->chgBus(c+1408,(vlSymsp->TOP__Briey.__PVT__axi_apbBridge_io_axi_arbiter__DOT__streamFifoLowLatency_5___DOT__popPtr_value),2);
	vcdp->chgBit(c+1409,((3U == (IData)(vlSymsp->TOP__Briey.__PVT__axi_apbBridge_io_axi_arbiter__DOT__streamFifoLowLatency_5___DOT__popPtr_value))));
	vcdp->chgBit(c+1410,(vlSymsp->TOP__Briey.__PVT__axi_apbBridge_io_axi_arbiter__DOT__streamFifoLowLatency_5___DOT__risingOccupancy));
	vcdp->chgBus(c+1411,((3U & ((IData)(vlSymsp->TOP__Briey.__PVT__axi_apbBridge_io_axi_arbiter__DOT__streamFifoLowLatency_5___DOT__pushPtr_value) 
				    - (IData)(vlSymsp->TOP__Briey.__PVT__axi_apbBridge_io_axi_arbiter__DOT__streamFifoLowLatency_5___DOT__popPtr_value)))),2);
	vcdp->chgBit(c+1412,(vlSymsp->TOP__Briey.__PVT___zz_51_));
	vcdp->chgBit(c+1413,(vlSymsp->TOP__Briey.__PVT__axi_gpu_io_axicpu_arbiter__DOT__cmdArbiter__DOT__locked));
	vcdp->chgBit(c+1414,(vlSymsp->TOP__Briey.__PVT__axi_gpu_io_axicpu_arbiter__DOT__cmdArbiter__DOT__maskLocked_0));
	vcdp->chgBit(c+1415,(vlSymsp->TOP__Briey.__PVT__axi_gpu_io_axicpu_arbiter__DOT__streamFork_5___DOT__linkEnable_0));
	vcdp->chgBit(c+1416,(vlSymsp->TOP__Briey.__PVT__axi_gpu_io_axicpu_arbiter__DOT__streamFork_5___DOT__linkEnable_1));
	vcdp->chgBus(c+1417,(vlSymsp->TOP__Briey.__PVT__axi_gpu_io_axicpu_arbiter__DOT__streamFifoLowLatency_5___DOT__pushPtr_value),2);
	vcdp->chgBit(c+1418,((3U == (IData)(vlSymsp->TOP__Briey.__PVT__axi_gpu_io_axicpu_arbiter__DOT__streamFifoLowLatency_5___DOT__pushPtr_value))));
	vcdp->chgBus(c+1419,(vlSymsp->TOP__Briey.__PVT__axi_gpu_io_axicpu_arbiter__DOT__streamFifoLowLatency_5___DOT__popPtr_value),2);
	vcdp->chgBit(c+1420,((3U == (IData)(vlSymsp->TOP__Briey.__PVT__axi_gpu_io_axicpu_arbiter__DOT__streamFifoLowLatency_5___DOT__popPtr_value))));
	vcdp->chgBit(c+1421,(vlSymsp->TOP__Briey.__PVT__axi_gpu_io_axicpu_arbiter__DOT__streamFifoLowLatency_5___DOT__risingOccupancy));
	vcdp->chgBus(c+1422,((3U & ((IData)(vlSymsp->TOP__Briey.__PVT__axi_gpu_io_axicpu_arbiter__DOT__streamFifoLowLatency_5___DOT__pushPtr_value) 
				    - (IData)(vlSymsp->TOP__Briey.__PVT__axi_gpu_io_axicpu_arbiter__DOT__streamFifoLowLatency_5___DOT__popPtr_value)))),2);
	vcdp->chgBus(c+1423,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__memory_to_writeBack_REGFILE_WRITE_DATA),32);
	vcdp->chgBus(c+1424,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__memory_to_writeBack_INSTRUCTION),32);
	vcdp->chgBit(c+1425,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_injector_nextPcCalc_valids_1));
	vcdp->chgBit(c+1426,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_injector_nextPcCalc_valids_2));
	vcdp->chgBit(c+1427,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_injector_nextPcCalc_valids_3));
	vcdp->chgBit(c+1428,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_injector_nextPcCalc_valids_4));
	vcdp->chgBit(c+1429,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__CsrPlugin_exceptionPortCtrl_exceptionValidsRegs_decode));
	vcdp->chgBit(c+1430,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__CsrPlugin_exceptionPortCtrl_exceptionValidsRegs_execute));
	vcdp->chgBit(c+1431,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__CsrPlugin_exceptionPortCtrl_exceptionValidsRegs_memory));
	vcdp->chgBit(c+1432,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__CsrPlugin_exceptionPortCtrl_exceptionValidsRegs_writeBack));
	vcdp->chgBit(c+1433,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT___zz_111_));
	vcdp->chgBit(c+1434,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_fetchPc_inc));
	vcdp->chgBit(c+1435,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT___zz_117_));
	vcdp->chgBit(c+1436,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT___zz_119_));
	vcdp->chgBit(c+1437,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_injector_nextPcCalc_valids_0));
	vcdp->chgBit(c+1438,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_injector_decodeRemoved));
	vcdp->chgBus(c+1439,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__memory_DivPlugin_div_counter_value),6);
	vcdp->chgBit(c+1440,((0x21U == (IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__memory_DivPlugin_div_counter_value))));
	vcdp->chgBit(c+1441,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__CsrPlugin_mstatus_MIE));
	vcdp->chgBit(c+1442,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__CsrPlugin_mstatus_MPIE));
	vcdp->chgBus(c+1443,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__CsrPlugin_mstatus_MPP),2);
	vcdp->chgBit(c+1444,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__CsrPlugin_mie_MEIE));
	vcdp->chgBit(c+1445,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__CsrPlugin_mie_MTIE));
	vcdp->chgBit(c+1446,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__CsrPlugin_mie_MSIE));
	vcdp->chgBit(c+1447,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__CsrPlugin_interrupt_valid));
	vcdp->chgBit(c+1448,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__CsrPlugin_hadException));
	vcdp->chgBit(c+1449,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__execute_CsrPlugin_wfiWake));
	vcdp->chgBit(c+1450,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT__lineLoader_valid));
	vcdp->chgBit(c+1451,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT__lineLoader_hadError));
	vcdp->chgBit(c+1452,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT__lineLoader_flushPending));
	vcdp->chgBit(c+1453,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT__lineLoader_cmdSent));
	vcdp->chgBus(c+1454,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__IBusCachedPlugin_cache__DOT__lineLoader_wordIndex),3);
	vcdp->chgBus(c+1455,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__dataCache_1___DOT__stageB_mmuRsp_physicalAddress),32);
	vcdp->chgBit(c+1456,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__dataCache_1___DOT__stageB_flusher_valid));
	vcdp->chgBit(c+1457,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__dataCache_1___DOT__stageB_memCmdSent));
	vcdp->chgBit(c+1458,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__dataCache_1___DOT__loader_valid));
	vcdp->chgBus(c+1459,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__dataCache_1___DOT__loader_counter_value),3);
	vcdp->chgBit(c+1460,((7U == (IData)(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__dataCache_1___DOT__loader_counter_value))));
	vcdp->chgBit(c+1461,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__dataCache_1___DOT__loader_waysAllocator));
	vcdp->chgBit(c+1462,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__dataCache_1___DOT__loader_error));
    }
}
...
void VBriey::traceChgThis__39(VBriey__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBit(c+1463,(((IData)(vlSymsp->TOP__Briey.__PVT__axi_ram__DOT__unburstify_buffer_valid)
...
void VBriey::traceChgThis__40(VBriey__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBus(c+1464,(vlSymsp->TOP__Briey.__PVT__axi_apbBridge_io_axi_arbiter_io_output_arw_halfPipe_regs_payload_addr),20);
	vcdp->chgBus(c+1465,(vlSymsp->TOP__Briey.__PVT__axi_apbBridge_io_axi_arbiter_io_output_w_halfPipe_regs_payload_data),32);
	vcdp->chgBus(c+1466,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__address),32);
	vcdp->chgBit(c+1467,(vlSymsp->TOP__Briey.__PVT__jtagBridge_1___DOT__flowCCByToggle_1___DOT__outputArea_flow_m2sPipe_payload_last));
	vcdp->chgBus(c+1468,(vlSymsp->TOP__Briey.__PVT__axi_gpu_io_axiram_ar_halfPipe_regs_payload_len),8);
	vcdp->chgBus(c+1469,(vlSymsp->TOP__Briey.__PVT___zz_57_),2);
	vcdp->chgBus(c+1470,(vlSymsp->TOP__Briey.__PVT__axi_ram_io_axi_arbiter_io_output_arw_halfPipe_regs_payload_len),8);
	vcdp->chgBus(c+1471,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl_io_axi_arbiter_io_output_arw_halfPipe_regs_payload_len),8);
	vcdp->chgBus(c+1472,(vlSymsp->TOP__Briey.__PVT__axi_ram__DOT__unburstify_buffer_beat),8);
	vcdp->chgBit(c+1473,((1U == (IData)(vlSymsp->TOP__Briey.__PVT__axi_ram__DOT__unburstify_buffer_beat))));
	vcdp->chgBus(c+1474,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__unburstify_buffer_beat),8);
	vcdp->chgBit(c+1475,((1U == (IData)(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__unburstify_buffer_beat))));
	vcdp->chgBus(c+1476,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT___zz_10_),3);
	vcdp->chgBus(c+1477,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl__DOT__ctrl__DOT___zz_11_),2);
	vcdp->chgBus(c+1478,((0xfU & vlSymsp->TOP__Briey.__PVT__axi_apbBridge_io_axi_arbiter_io_output_arw_halfPipe_regs_payload_addr)),4);
	vcdp->chgBus(c+1479,((0xffU & vlSymsp->TOP__Briey.__PVT__axi_apbBridge_io_axi_arbiter_io_output_arw_halfPipe_regs_payload_addr)),8);
	vcdp->chgBit(c+1480,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__bridge_uartConfigReg_frame_stop));
	vcdp->chgBus(c+1481,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__bridge_uartConfigReg_frame_parity),2);
	vcdp->chgBus(c+1482,((0xffU & vlSymsp->TOP__Briey.__PVT__axi_apbBridge_io_axi_arbiter_io_output_w_halfPipe_regs_payload_data)),8);
	vcdp->chgBus(c+1483,(((IData)(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__bridge_uartConfigReg_frame_stop)
			       ? ((IData)(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__bridge_uartConfigReg_frame_stop)
				   ? 0x54574fU : 0x3f3f3fU)
			       : 0x4f4e45U)),24);
	vcdp->chgBus(c+1484,(((0U == (IData)(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__bridge_uartConfigReg_frame_parity))
			       ? 0x4e4f4e45U : ((1U 
						...
						((2U 
						  ...
						  ? 0x4f444420U
						  : 0x3f3f3f3fU)))),32);
	vcdp->chgBus(c+1485,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___DOT__tx__DOT__tickCounter_value),3);
	vcdp->chgBus(c+1486,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___DOT__rx__DOT__bitCounter_value),3);
	vcdp->chgBit(c+1487,(vlSymsp->TOP__Briey.__PVT__axi_uartCtrl__DOT__uartCtrl_1___DOT__rx__DOT__stateMachine_parity));
	vcdp->chgBus(c+1488,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__buffer_2_),32);
	vcdp->chgBit(c+1489,(vlSymsp->TOP__Briey.__PVT__jtagBridge_1___DOT__system_rsp_valid));
	vcdp->chgBit(c+1490,(vlSymsp->TOP__Briey.__PVT__jtagBridge_1___DOT__system_rsp_payload_error));
	vcdp->chgBus(c+1491,(vlSymsp->TOP__Briey.__PVT__jtagBridge_1___DOT__system_rsp_payload_data),32);
	vcdp->chgBit(c+1492,((0U == (IData)(vlSymsp->TOP__Briey.__PVT__axi_core_iBus_decoder__DOT__errorSlave__DOT__remaining))));
	vcdp->chgBus(c+1493,(vlSymsp->TOP__Briey.__PVT__axi_core_iBus_decoder__DOT__errorSlave__DOT__remaining),8);
	vcdp->chgBit(c+1494,((0U == (IData)(vlSymsp->TOP__Briey.__PVT__axi_core_dBus_decoder__DOT__errorSlave__DOT__remaining))));
	vcdp->chgBus(c+1495,(vlSymsp->TOP__Briey.__PVT__axi_core_dBus_decoder__DOT__errorSlave__DOT__remaining),8);
	vcdp->chgBit(c+1496,((0U == (IData)(vlSymsp->TOP__Briey.__PVT__axi_gpu_io_axiram_decoder__DOT__errorSlave__DOT__remaining))));
	vcdp->chgBus(c+1497,(vlSymsp->TOP__Briey.__PVT__axi_gpu_io_axiram_decoder__DOT__errorSlave__DOT__remaining),8);
	vcdp->chgBit(c+1498,((0U != (IData)(vlSymsp->TOP__Briey.__PVT___zz_57_))));
	vcdp->chgBus(c+1499,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__execute_to_memory_REGFILE_WRITE_DATA),32);
	vcdp->chgBus(c+1500,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__execute_to_memory_INSTRUCTION),32);
	vcdp->chgBus(c+1501,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_INSTRUCTION),32);
	vcdp->chgBit(c+1502,((0xfU == (0xfU & (vlSymsp->TOP__Briey__axi_core_cpu.__PVT__execute_to_memory_REGFILE_WRITE_DATA 
					       >> 0x1cU)))));
	vcdp->chgBus(c+1503,((3U & (vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_INSTRUCTION 
				    >> 0xcU))),2);
	vcdp->chgBit(c+1504,(((1U == (3U & (vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_INSTRUCTION 
					    >> 0xcU))) 
			      | (2U == (3U & (vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_INSTRUCTION 
					      >> 0xcU))))));
	vcdp->chgBit(c+1505,((1U == (3U & (vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_INSTRUCTION 
					   >> 0xcU)))));
	vcdp->chgBus(c+1506,((0xfffU & (vlSymsp->TOP__Briey__axi_core_cpu.__PVT__decode_to_execute_INSTRUCTION 
					>> 0x14U))),12);
	vcdp->chgBit(c+1507,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__DebugPlugin_isPipBusy));
    }
}
...
void VBriey::traceChgThis__41(VBriey__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBit(c+1508,(vlSymsp->TOP__Briey.__PVT__jtagBridge_1___DOT__flowCCByToggle_1___DOT__outputArea_flow_m2sPipe_valid));
	vcdp->chgBit(c+1509,(vlSymsp->TOP__Briey.__PVT___zz_36_));
    }
}
...
void VBriey::traceChgThis__42(VBriey__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBit(c+1510,(vlSymsp->TOP__Briey.__PVT__axi_gpu_io_axiram_ar_halfPipe_regs_valid));
	vcdp->chgBit(c+1511,(vlSymsp->TOP__Briey.__PVT__axi_ram_io_axi_arbiter_io_output_arw_halfPipe_regs_valid));
	vcdp->chgBit(c+1512,(vlSymsp->TOP__Briey.__PVT__axi_sdramCtrl_io_axi_arbiter_io_output_arw_halfPipe_regs_valid));
	vcdp->chgBit(c+1513,(vlSymsp->TOP__Briey.__PVT__axi_apbBridge_io_axi_arbiter_io_output_arw_halfPipe_regs_valid));
	vcdp->chgBit(c+1514,(vlSymsp->TOP__Briey.__PVT__axi_apbBridge_io_axi_arbiter_io_output_w_halfPipe_regs_valid));
	vcdp->chgBus(c+1515,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__mcpState_readData_fsm_stateReg),3);
	vcdp->chgBus(c+1516,(vlSymsp->TOP__Briey.__PVT__axi_gpu__DOT__mcpState_stateReg),3);
	vcdp->chgBit(c+1517,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__execute_arbitration_isValid));
	vcdp->chgBit(c+1518,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__memory_arbitration_isValid));
	vcdp->chgBit(c+1519,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__writeBack_arbitration_isValid));
    }
}
...
void VBriey::traceChgThis__43(VBriey__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBit(c+1520,(vlSymsp->TOP__Briey.__PVT__jtagBridge_1___DOT__flowCCByToggle_1___DOT__inputArea_data_last));
    }
}
...
void VBriey::traceChgThis__44(VBriey__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBit(c+1521,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__DebugPlugin_resetIt_regNext));
	vcdp->chgBit(c+1522,(vlSymsp->TOP__Briey.__PVT__resetCtrl_axiReset));
	vcdp->chgBit(c+1523,(vlSymsp->TOP__Briey.__PVT__axi_core_cpu_debug_resetOut_regNext));
    }
}
...
void VBriey::traceChgThis__45(VBriey__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBit(c+1524,(vlSymsp->TOP__Briey__axi_core_cpu.__PVT__DebugPlugin_resetIt));
    }
}
...
void VBriey::traceChgThis__46(VBriey__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBus(c+1525,(vlSymsp->TOP__Briey.__PVT__systemDebugger_1___DOT__dispatcher_dataShifter[0U]),32);
	vcdp->chgBus(c+1526,(vlSymsp->TOP__Briey.__PVT__systemDebugger_1___DOT__dispatcher_dataShifter[1U]),32);
	vcdp->chgBit(c+1527,((1U & vlSymsp->TOP__Briey.__PVT__systemDebugger_1___DOT__dispatcher_dataShifter[2U])));
	vcdp->chgBus(c+1528,((3U & (vlSymsp->TOP__Briey.__PVT__systemDebugger_1___DOT__dispatcher_dataShifter[2U] 
				    >> 1U))),2);
	vcdp->chgBit(c+1529,(vlSymsp->TOP__Briey.__PVT__resetCtrl_systemReset));
	vcdp->chgArray(c+1530,(vlSymsp->TOP__Briey.__PVT__systemDebugger_1___DOT__dispatcher_dataShifter),67);
	vcdp->chgBus(c+1533,((0xffU & vlSymsp->TOP__Briey.__PVT__systemDebugger_1___DOT__dispatcher_dataShifter[0U])),8);
    }
}
...
void VBriey::traceChgThis__47(VBriey__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBit(c+1534,(vlTOPp->io_asyncReset));
	vcdp->chgBit(c+1535,(vlTOPp->io_axiClk));
	vcdp->chgBit(c+1536,(vlTOPp->io_vgaClk));
	vcdp->chgBit(c+1537,(vlTOPp->io_jtag_tms));
	vcdp->chgBit(c+1538,(vlTOPp->io_jtag_tdi));
	vcdp->chgBit(c+1539,(vlTOPp->io_jtag_tdo));
	vcdp->chgBit(c+1540,(vlTOPp->io_jtag_tck));
	vcdp->chgBus(c+1541,(vlTOPp->io_sdram_ADDR),13);
	vcdp->chgBus(c+1542,(vlTOPp->io_sdram_BA),2);
	vcdp->chgBus(c+1543,(vlTOPp->io_sdram_DQ_read),16);
	vcdp->chgBus(c+1544,(vlTOPp->io_sdram_DQ_write),16);
	vcdp->chgBit(c+1545,(vlTOPp->io_sdram_DQ_writeEnable));
	vcdp->chgBus(c+1546,(vlTOPp->io_sdram_DQM),2);
	vcdp->chgBit(c+1547,(vlTOPp->io_sdram_CASn));
	vcdp->chgBit(c+1548,(vlTOPp->io_sdram_CKE));
	vcdp->chgBit(c+1549,(vlTOPp->io_sdram_CSn));
	vcdp->chgBit(c+1550,(vlTOPp->io_sdram_RASn));
	vcdp->chgBit(c+1551,(vlTOPp->io_sdram_WEn));
	vcdp->chgBus(c+1552,(vlTOPp->io_gpioA_read),32);
	vcdp->chgBus(c+1553,(vlTOPp->io_gpioA_write),32);
	vcdp->chgBus(c+1554,(vlTOPp->io_gpioA_writeEnable),32);
	vcdp->chgBus(c+1555,(vlTOPp->io_gpioB_read),32);
	vcdp->chgBus(c+1556,(vlTOPp->io_gpioB_write),32);
	vcdp->chgBus(c+1557,(vlTOPp->io_gpioB_writeEnable),32);
	vcdp->chgBit(c+1558,(vlTOPp->io_uart_txd));
	vcdp->chgBit(c+1559,(vlTOPp->io_uart_rxd));
	vcdp->chgBit(c+1560,(vlTOPp->io_vga_hSync));
	vcdp->chgBit(c+1561,(vlTOPp->io_vga_vSync));
	vcdp->chgBus(c+1562,(vlTOPp->io_vga_rgb_0),5);
	vcdp->chgBus(c+1563,(vlTOPp->io_vga_rgb_1),6);
	vcdp->chgBus(c+1564,(vlTOPp->io_vga_rgb_2),5);
	vcdp->chgBit(c+1565,(vlTOPp->io_vga_colorEn));
	vcdp->chgBit(c+1566,(vlTOPp->io_vga_videoClock));
	vcdp->chgBit(c+1567,(vlTOPp->io_timerExternal_clear));
	vcdp->chgBit(c+1568,(vlTOPp->io_timerExternal_tick));
	vcdp->chgBit(c+1569,(vlTOPp->io_coreInterrupt));
	vcdp->chgBus(c+1570,(vlSymsp->TOP__Briey__axi_core_cpu.IBusCachedPlugin_fetchPc_pcReg),32);
	vcdp->chgBus(c+1571,(vlSymsp->TOP__Briey__axi_core_cpu.lastStageInstruction),32);
	vcdp->chgBus(c+1572,(vlSymsp->TOP__Briey__axi_core_cpu.lastStagePc),32);
	vcdp->chgBit(c+1573,(vlSymsp->TOP__Briey__axi_core_cpu.lastStageIsValid));
	vcdp->chgBit(c+1574,(vlSymsp->TOP__Briey__axi_core_cpu.lastStageIsFiring));
	vcdp->chgBit(c+1575,((0xfU == (0xfU & (vlSymsp->TOP__Briey__axi_core_cpu.IBusCachedPlugin_fetchPc_pcReg 
					       >> 0x1cU)))));
	vcdp->chgBit(c+1576,(vlSymsp->TOP__Briey__axi_core_cpu.lastStageRegFileWrite_valid));
	vcdp->chgBus(c+1577,(vlSymsp->TOP__Briey__axi_core_cpu.lastStageRegFileWrite_payload_address),5);
	vcdp->chgBus(c+1578,(vlSymsp->TOP__Briey__axi_core_cpu.lastStageRegFileWrite_payload_data),32);
	vcdp->chgBus(c+1579,(vlSymsp->TOP__Briey__axi_core_cpu.CsrPlugin_interrupt_code),4);
	vcdp->chgBit(c+1580,(vlSymsp->TOP__Briey__axi_core_cpu.CsrPlugin_interruptJump));
	vcdp->chgBit(c+1581,(vlSymsp->TOP__Briey__axi_core_cpu.execute_CsrPlugin_inWfi));
	vcdp->chgBus(c+1582,(vlSymsp->TOP__Briey__axi_core_cpu.RegFilePlugin_regFile[0]),32);
	vcdp->chgBus(c+1583,(vlSymsp->TOP__Briey__axi_core_cpu.RegFilePlugin_regFile[1]),32);
	vcdp->chgBus(c+1584,(vlSymsp->TOP__Briey__axi_core_cpu.RegFilePlugin_regFile[2]),32);
	vcdp->chgBus(c+1585,(vlSymsp->TOP__Briey__axi_core_cpu.RegFilePlugin_regFile[3]),32);
	vcdp->chgBus(c+1586,(vlSymsp->TOP__Briey__axi_core_cpu.RegFilePlugin_regFile[4]),32);
	vcdp->chgBus(c+1587,(vlSymsp->TOP__Briey__axi_core_cpu.RegFilePlugin_regFile[5]),32);
	vcdp->chgBus(c+1588,(vlSymsp->TOP__Briey__axi_core_cpu.RegFilePlugin_regFile[6]),32);
	vcdp->chgBus(c+1589,(vlSymsp->TOP__Briey__axi_core_cpu.RegFilePlugin_regFile[7]),32);
	vcdp->chgBus(c+1590,(vlSymsp->TOP__Briey__axi_core_cpu.RegFilePlugin_regFile[8]),32);
	vcdp->chgBus(c+1591,(vlSymsp->TOP__Briey__axi_core_cpu.RegFilePlugin_regFile[9]),32);
	vcdp->chgBus(c+1592,(vlSymsp->TOP__Briey__axi_core_cpu.RegFilePlugin_regFile[10]),32);
	vcdp->chgBus(c+1593,(vlSymsp->TOP__Briey__axi_core_cpu.RegFilePlugin_regFile[11]),32);
	vcdp->chgBus(c+1594,(vlSymsp->TOP__Briey__axi_core_cpu.RegFilePlugin_regFile[12]),32);
	vcdp->chgBus(c+1595,(vlSymsp->TOP__Briey__axi_core_cpu.RegFilePlugin_regFile[13]),32);
	vcdp->chgBus(c+1596,(vlSymsp->TOP__Briey__axi_core_cpu.RegFilePlugin_regFile[14]),32);
	vcdp->chgBus(c+1597,(vlSymsp->TOP__Briey__axi_core_cpu.RegFilePlugin_regFile[15]),32);
	vcdp->chgBus(c+1598,(vlSymsp->TOP__Briey__axi_core_cpu.RegFilePlugin_regFile[16]),32);
	vcdp->chgBus(c+1599,(vlSymsp->TOP__Briey__axi_core_cpu.RegFilePlugin_regFile[17]),32);
	vcdp->chgBus(c+1600,(vlSymsp->TOP__Briey__axi_core_cpu.RegFilePlugin_regFile[18]),32);
	vcdp->chgBus(c+1601,(vlSymsp->TOP__Briey__axi_core_cpu.RegFilePlugin_regFile[19]),32);
	vcdp->chgBus(c+1602,(vlSymsp->TOP__Briey__axi_core_cpu.RegFilePlugin_regFile[20]),32);
	vcdp->chgBus(c+1603,(vlSymsp->TOP__Briey__axi_core_cpu.RegFilePlugin_regFile[21]),32);
	vcdp->chgBus(c+1604,(vlSymsp->TOP__Briey__axi_core_cpu.RegFilePlugin_regFile[22]),32);
	vcdp->chgBus(c+1605,(vlSymsp->TOP__Briey__axi_core_cpu.RegFilePlugin_regFile[23]),32);
	vcdp->chgBus(c+1606,(vlSymsp->TOP__Briey__axi_core_cpu.RegFilePlugin_regFile[24]),32);
	vcdp->chgBus(c+1607,(vlSymsp->TOP__Briey__axi_core_cpu.RegFilePlugin_regFile[25]),32);
	vcdp->chgBus(c+1608,(vlSymsp->TOP__Briey__axi_core_cpu.RegFilePlugin_regFile[26]),32);
	vcdp->chgBus(c+1609,(vlSymsp->TOP__Briey__axi_core_cpu.RegFilePlugin_regFile[27]),32);
	vcdp->chgBus(c+1610,(vlSymsp->TOP__Briey__axi_core_cpu.RegFilePlugin_regFile[28]),32);
	vcdp->chgBus(c+1611,(vlSymsp->TOP__Briey__axi_core_cpu.RegFilePlugin_regFile[29]),32);
	vcdp->chgBus(c+1612,(vlSymsp->TOP__Briey__axi_core_cpu.RegFilePlugin_regFile[30]),32);
	vcdp->chgBus(c+1613,(vlSymsp->TOP__Briey__axi_core_cpu.RegFilePlugin_regFile[31]),32);
    }
}
