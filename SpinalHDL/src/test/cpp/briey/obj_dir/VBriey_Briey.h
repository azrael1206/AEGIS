...
VL_MODULE(VBriey_Briey) {
  public:
	...
	VL_SIG8(__PVT__axi_sdramCtrl__DOT__ctrl__DOT__bubbleInserter_timings_banks_0_precharge_counter,1,0);
	VL_SIG8(__PVT__axi_sdramCtrl__DOT__ctrl__DOT__bubbleInserter_timings_banks_0_precharge_busy,0,0);
	VL_SIG8(__PVT__axi_sdramCtrl__DOT__ctrl__DOT__bubbleInserter_timings_banks_0_active_counter,1,0);
	VL_SIG8(__PVT__axi_sdramCtrl__DOT__ctrl__DOT__bubbleInserter_timings_banks_0_active_busy,0,0);
	VL_SIG8(__PVT__axi_sdramCtrl__DOT__ctrl__DOT__bubbleInserter_timings_banks_1_precharge_counter,1,0);
	VL_SIG8(__PVT__axi_sdramCtrl__DOT__ctrl__DOT__bubbleInserter_timings_banks_1_precharge_busy,0,0);
	VL_SIG8(__PVT__axi_sdramCtrl__DOT__ctrl__DOT__bubbleInserter_timings_banks_1_active_counter,1,0);
	VL_SIG8(__PVT__axi_sdramCtrl__DOT__ctrl__DOT__bubbleInserter_timings_banks_1_active_busy,0,0);
	VL_SIG8(__PVT__axi_sdramCtrl__DOT__ctrl__DOT__bubbleInserter_timings_banks_2_precharge_counter,1,0);
	VL_SIG8(__PVT__axi_sdramCtrl__DOT__ctrl__DOT__bubbleInserter_timings_banks_2_precharge_busy,0,0);
	VL_SIG8(__PVT__axi_sdramCtrl__DOT__ctrl__DOT__bubbleInserter_timings_banks_2_active_counter,1,0);
	VL_SIG8(__PVT__axi_sdramCtrl__DOT__ctrl__DOT__bubbleInserter_timings_banks_2_active_busy,0,0);
	VL_SIG8(__PVT__axi_sdramCtrl__DOT__ctrl__DOT__bubbleInserter_timings_banks_3_precharge_counter,1,0);
	VL_SIG8(__PVT__axi_sdramCtrl__DOT__ctrl__DOT__bubbleInserter_timings_banks_3_precharge_busy,0,0);
    };
    struct {
	VL_SIG8(__PVT__axi_sdramCtrl__DOT__ctrl__DOT__bubbleInserter_timings_banks_3_active_counter,1,0);
	...
	VL_SIG8(__PVT__axi_gpu__DOT___zz_6_,0,0);
	VL_SIG8(__PVT__axi_gpu__DOT___zz_11_,0,0);
	VL_SIG8(__PVT__axi_gpu__DOT___zz_15_,0,0);
	VL_SIG8(__PVT__axi_gpu__DOT___zz_17_,7,0);
	VL_SIG8(__PVT__axi_gpu__DOT___zz_19_,7,0);
	VL_SIG8(__PVT__axi_gpu__DOT___zz_20_,0,0);
	...
	VL_SIG8(__PVT__axi_gpu__DOT__bresCircle_io_address_1,7,0);
	VL_SIG8(__PVT__axi_gpu__DOT__fillRect_io_ready,0,0);
	VL_SIG8(__PVT__axi_gpu__DOT__fillRect_io_setPixel,0,0);
	VL_SIG8(__PVT__axi_gpu__DOT__blitterFont_io_write,0,0);
	VL_SIG8(__PVT__axi_gpu__DOT__blitterFont_io_ready,0,0);
    };
    struct {
	VL_SIG8(__PVT__axi_gpu__DOT___zz_25_,0,0);
	VL_SIG8(__PVT__axi_gpu__DOT__id,3,0);
	VL_SIG8(__PVT__axi_gpu__DOT__storeVals1_1,7,0);
	VL_SIG8(__PVT__axi_gpu__DOT__storeVals2_1,7,0);
	...
	VL_SIG8(__PVT__axi_gpu__DOT__len,7,0);
	VL_SIG8(__PVT__axi_gpu__DOT__valid,0,0);
	VL_SIG8(__PVT__axi_gpu__DOT__storeCircle_1,7,0);
	VL_SIG8(__PVT__axi_gpu__DOT__storeSprite_1,7,0);
	VL_SIG8(__PVT__axi_gpu__DOT__storeFont_1,7,0);
	VL_SIG8(__PVT__axi_gpu__DOT__mcpState_readData_fsm_wantExit,0,0);
	VL_SIG8(__PVT__axi_gpu__DOT__mcpState_readData_fsm_stateReg,3,0);
	VL_SIG8(__PVT__axi_gpu__DOT__mcpState_readData_fsm_stateNext,3,0);
	VL_SIG8(__PVT__axi_gpu__DOT__mcpState_stateReg,3,0);
	VL_SIG8(__PVT__axi_gpu__DOT__mcpState_stateNext,3,0);
	...
	VL_SIG8(__PVT__axi_gpu__DOT__vga__DOT__vga__DOT___zz_1_,0,0);
	...
	VL_SIG8(__PVT__axi_gpu__DOT__bresLine__DOT__y,7,0);
	VL_SIG8(__PVT__axi_gpu__DOT__bresLine__DOT__y2,7,0);
	...
	VL_SIG8(__PVT__axi_gpu__DOT__fillRect__DOT__counterY,7,0);
	VL_SIG8(__PVT__axi_gpu__DOT__fillRect__DOT__y2,7,0);
	...
	VL_SIG8(__PVT__axi_gpu__DOT__blitterFont__DOT___zz_1_,0,0);
	VL_SIG8(__PVT__axi_gpu__DOT__blitterFont__DOT___zz_2_,7,0);
	VL_SIG8(__PVT__axi_gpu__DOT__blitterFont__DOT___zz_11_,3,0);
	VL_SIG8(__PVT__axi_gpu__DOT__blitterFont__DOT__x,3,0);
	VL_SIG8(__PVT__axi_gpu__DOT__blitterFont__DOT__y,3,0);
	VL_SIG8(__PVT__axi_gpu__DOT__blitterFont__DOT__state_stateReg,1,0);
	VL_SIG8(__PVT__axi_gpu__DOT__blitterFont__DOT__state_stateNext,1,0);
	...
	VL_SIG16(__PVT__axi_sdramCtrl__DOT__ctrl__DOT__refresh_counter_valueNext,8,0);
	VL_SIG16(__PVT__axi_sdramCtrl__DOT__ctrl__DOT__refresh_counter_value,8,0);
	VL_SIG16(__PVT__axi_sdramCtrl__DOT__ctrl__DOT__powerup_counter,12,0);
	...
	VL_SIG16(__PVT__axi_gpu__DOT___zz_8_,8,0);
	VL_SIG16(__PVT__axi_gpu__DOT___zz_9_,9,0);
	VL_SIG16(__PVT__axi_gpu__DOT___zz_10_,8,0);
	VL_SIG16(__PVT__axi_gpu__DOT___zz_12_,9,0);
	VL_SIG16(__PVT__axi_gpu__DOT___zz_13_,8,0);
	VL_SIG16(__PVT__axi_gpu__DOT___zz_14_,9,0);
	VL_SIG16(__PVT__axi_gpu__DOT___zz_16_,8,0);
	VL_SIG16(__PVT__axi_gpu__DOT___zz_18_,8,0);
	VL_SIG16(__PVT__axi_gpu__DOT__bresCircle_io_address_0,8,0);
	VL_SIG16(__PVT__axi_gpu__DOT__storeVals1_0,8,0);
	VL_SIG16(__PVT__axi_gpu__DOT__storeVals2_0,8,0);
	VL_SIG16(__PVT__axi_gpu__DOT__storeRadius,8,0);
	VL_SIG16(__PVT__axi_gpu__DOT__storeCircle_0,8,0);
	VL_SIG16(__PVT__axi_gpu__DOT__storeSprite_0,8,0);
	VL_SIG16(__PVT__axi_gpu__DOT__storeFont_0,8,0);
	...
	VL_SIG16(__PVT__axi_gpu__DOT__bresLine__DOT___zz_7_,9,0);
	VL_SIG16(__PVT__axi_gpu__DOT__bresLine__DOT__dx,9,0);
	VL_SIG16(__PVT__axi_gpu__DOT__bresLine__DOT__dy,8,0);
	VL_SIG16(__PVT__axi_gpu__DOT__bresLine__DOT__x,8,0);
	VL_SIG16(__PVT__axi_gpu__DOT__bresLine__DOT__x2,8,0);
	VL_SIG16(__PVT__axi_gpu__DOT__bresCircle__DOT__x,10,0);
	VL_SIG16(__PVT__axi_gpu__DOT__bresCircle__DOT__y,9,0);
	VL_SIG16(__PVT__axi_gpu__DOT__bresCircle__DOT__x1,9,0);
	VL_SIG16(__PVT__axi_gpu__DOT__bresCircle__DOT__y1,8,0);
	VL_SIG16(__PVT__axi_gpu__DOT__fillRect__DOT__counterX,8,0);
	VL_SIG16(__PVT__axi_gpu__DOT__fillRect__DOT__x1,8,0);
	VL_SIG16(__PVT__axi_gpu__DOT__fillRect__DOT__x2,8,0);
	...
	VL_SIG(__PVT__axi_ram_io_axi_arbiter_io_output_arw_halfPipe_regs_payload_addr,16,0);
	...
	VL_SIG(__PVT__axi_ram__DOT__arw_payload_fragment_addr,16,0);
	VL_SIG(__PVT__axi_ram__DOT__unburstify_buffer_transaction_addr,16,0);
	VL_SIG(__PVT__axi_ram__DOT__unburstify_buffer_result,16,0);
	VL_SIG(__PVT__axi_ram__DOT___zz_8_,16,0);
	...
	VL_SIG(__PVT__axi_gpu__DOT___zz_5_,17,0);
	VL_SIG(__PVT__axi_gpu__DOT__address,27,0);
	VL_SIG(__PVT__axi_gpu__DOT__raddress,31,0);
	...
	VL_SIG(__PVT__axi_gpu__DOT__bresLine__DOT___zz_10_,17,0);
	VL_SIG(__PVT__axi_gpu__DOT__bresLine__DOT___zz_11_,17,0);
	VL_SIG(__PVT__axi_gpu__DOT__bresLine__DOT___zz_12_,17,0);
	VL_SIG(__PVT__axi_gpu__DOT__bresLine__DOT___zz_13_,17,0);
	VL_SIG(__PVT__axi_gpu__DOT__bresLine__DOT__err,17,0);
	VL_SIG(__PVT__axi_gpu__DOT__bresLine__DOT__e2,17,0);
	...
	VL_SIG(__PVT__axi_gpu__DOT__bresCircle__DOT___zz_39_,18,0);
	VL_SIG(__PVT__axi_gpu__DOT__bresCircle__DOT___zz_45_,18,0);
	VL_SIG(__PVT__axi_gpu__DOT__bresCircle__DOT___zz_46_,18,0);
	VL_SIG(__PVT__axi_gpu__DOT__bresCircle__DOT___zz_48_,18,0);
    };
    struct {
	VL_SIG(__PVT__axi_gpu__DOT__bresCircle__DOT__err,18,0);
	VL_SIG(__PVT__axi_gpu__DOT__bresCircle__DOT__rTemp,18,0);
	...
	VL_SIG8(__PVT__axi_ram__DOT__ram_symbol0[32768],7,0);
	VL_SIG8(__PVT__axi_ram__DOT__ram_symbol1[32768],7,0);
	VL_SIG8(__PVT__axi_ram__DOT__ram_symbol2[32768],7,0);
	VL_SIG8(__PVT__axi_ram__DOT__ram_symbol3[32768],7,0);
	...
	VL_SIG8(__PVT__axi_gpu__DOT__vga__DOT__buffer_2___DOT__bufferFrame[262144],2,0);
    };
    ...
    VL_SIG8(__Vtableidx28,4,0);
    VL_SIG8(__Vtableidx29,3,0);
    VL_SIG8(__Vtableidx30,4,0);
    VL_SIG8(__Vtableidx31,4,0);
    VL_SIG8(__Vtableidx32,4,0);
    VL_SIG8(__Vtableidx33,3,0);
    VL_SIG8(__Vtableidx34,4,0);
    VL_SIG8(__Vtableidx35,2,0);
    VL_SIG8(__Vtableidx36,2,0);
    VL_SIG8(__Vtableidx37,2,0);
    VL_SIG8(__Vtableidx38,2,0);
    VL_SIG8(__Vtableidx39,2,0);
    VL_SIG8(__Vtableidx40,3,0);
    VL_SIG8(__Vtableidx41,3,0);
    VL_SIG8(__Vtableidx43,4,0);
    ...
    static VL_ST_SIG(__Vtable24___PVT__axi_gpu__DOT__mcpState_readData_fsm_stateReg_string[16],31,0);
    static VL_ST_SIG(__Vtable25___PVT__axi_gpu__DOT__mcpState_readData_fsm_stateNext_string[16],31,0);
    static VL_ST_SIGW(__Vtable26___PVT__axi_gpu__DOT__mcpState_stateReg_string[16],159,0,5);
    static VL_ST_SIGW(__Vtable27___PVT__axi_gpu__DOT__mcpState_stateNext_string[16],159,0,5);
    static VL_ST_SIG8(__Vtable28___PVT__axi_gpu__DOT___zz_6_[32],0,0);
    static VL_ST_SIG8(__Vtable29___PVT__axi_gpu_io_axicpu_arw_ready[16],0,0);
    static VL_ST_SIG8(__Vtable30___PVT__axi_gpu_io_axicpu_w_ready[32],0,0);
    static VL_ST_SIG8(__Vtable31___PVT__axi_gpu_io_axicpu_b_valid[32],0,0);
    static VL_ST_SIG8(__Vtable32___PVT__axi_gpu_io_axicpu_r_valid[32],0,0);
    static VL_ST_SIG8(__Vtable33___PVT__axi_gpu__DOT__mcpState_readData_fsm_wantExit[16],0,0);
    static VL_ST_SIG8(__Vtable34___PVT__axi_gpu_io_axiram_r_ready[32],0,0);
    static VL_ST_SIGW(__Vtable35___PVT__axi_gpu__DOT__bresLine__DOT__breshamSM_stateReg_string[8],135,0,5);
    static VL_ST_SIGW(__Vtable36___PVT__axi_gpu__DOT__bresLine__DOT__breshamSM_stateNext_string[8],135,0,5);
    static VL_ST_SIG8(__Vtable37___PVT__axi_gpu__DOT__bresLine_io_ready[8],0,0);
    static VL_ST_SIGW(__Vtable38___PVT__axi_gpu__DOT__bresCircle__DOT__BreshamCircSM_stateReg_string[8],183,0,6);
    static VL_ST_SIGW(__Vtable39___PVT__axi_gpu__DOT__bresCircle__DOT__BreshamCircSM_stateNext_string[8],183,0,6);
    static VL_ST_SIGW(__Vtable40___PVT__jtagBridge_1___DOT__jtag_tap_fsm_stateNext_string[16],79,0,3);
    static VL_ST_SIGW(__Vtable41___PVT__jtagBridge_1___DOT__jtag_tap_fsm_state_string[16],79,0,3);
    static VL_ST_SIG8(__Vtable43___PVT__jtagBridge_1___DOT___zz_1_[32],3,0);
  ...
  public:
    static void _initial__TOP__Briey__1(VBriey__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    ...
    static void _sequent__TOP__Briey__14(VBriey__Syms* __restrict vlSymsp);
    ...
    static void _sequent__TOP__Briey__2(VBriey__Syms* __restrict vlSymsp);
    static void _sequent__TOP__Briey__3(VBriey__Syms* __restrict vlSymsp);
    ...
    static void _settle__TOP__Briey__10(VBriey__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    static void _settle__TOP__Briey__9(VBriey__Syms* __restrict vlSymsp) VL_ATTR_COLD;
