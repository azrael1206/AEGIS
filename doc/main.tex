...
\fancyhead[C]{AEGIS - An Architecture for Embedded Graphical Interfaces} % Custom header text
...
\begin{document}
	...
	\input{src/desimpl_gpu}
	
	\subsection{VGA and Framebuffer}
	\input{src/desimpl_vga}
	
	\subsection{Bresenham Line and Circle}\label{subsec:des_bresenham}
	\input{src/desimp_bresenham}
	
	\subsection{Bit Blit}\label{subsec:des_blit}
	\input{src/desimpl_blit}
	
	\subsection{AEGIS Core}\label{subsec:core}
	\input{src/desimpl_core}
	
	\subsection{Application Programming Interface}
	\input{src/desimpl_api}
